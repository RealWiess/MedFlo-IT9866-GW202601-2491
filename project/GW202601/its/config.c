...
void ConfigInit(void)
{
	...
	theConfig.reclevel = iniparser_getint(cfgIni, "ctrlboard:reclevel", 50);
    ...
    // dashboard
    theConfig.odometer = iniparser_getint(cfgIni, "dashboard:odometer", 0);
    theConfig.tripA_meter = iniparser_getint(cfgIni, "dashboard:tripA_meter", 0);
    ...
    // SSID2 (備用)
    snprintf(theConfig.ssid2, 64, iniparser_getstring(cfgIni, "wifi:ssid2", ""));
    // Password2 (備用)
    snprintf(theConfig.password2, 256, iniparser_getstring(cfgIni, "wifi:password2", ""));
    // Security mode 2 (備用)
    snprintf(theConfig.secumode2, 3, iniparser_getstring(cfgIni, "wifi:secumode2", "NA"));
...
static void ConfigSavePublic(void)
{
    ...
    sprintf(buf, "%d", theConfig.reclevel);
    iniparser_set(cfgIni, "ctrlboard:reclevel", buf);
    ...
    // dashboard
    sprintf(buf, "%d", theConfig.odometer);
    iniparser_set(cfgIni, "dashboard:odometer", buf);
    sprintf(buf, "%d", theConfig.tripA_meter);
    iniparser_set(cfgIni, "dashboard:tripA_meter", buf);
    ...
    // SSID2 (備用)
    iniparser_set(cfgIni, "wifi:ssid2", theConfig.ssid2);
    // Password2 (備用)
    iniparser_set(cfgIni, "wifi:password2", theConfig.password2);
    // Security mode 2 (備用)
    iniparser_set(cfgIni, "wifi:secumode2", theConfig.secumode2);
    // wifi mode
