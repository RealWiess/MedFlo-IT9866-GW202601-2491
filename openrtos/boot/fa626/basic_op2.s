...
InterPolate:
stmfd r13!,{r4-r11,r14}@r0:accum,r1:sinct,r2:osr,r3:ofst
ldr r12,[r13,#40]@r12=N
ldr r14,[r13,#36]@r14=iptr
add r14,r14,r12,lsl #1@2B
sub r14,r14,#2@iptr[N-1]
ldr r6,=0xfffffffc
ands r4,r14,#3
add r1,r1,#8@4*2B
mul r7,r2,r12
...
mov r9,#0@[-1]
ldreqsh r3,[r1,#-2]
smlabbeq r8,r5,r11,r8
ldreqsh r11,[r1,#2]
mov r10,#0@[1]
smlabbeq r9,r5,r3,r9
ldreqsh r3,[r1],-r2
smlabbeq r10,r5,r11,r10
and r14,r14,r6
smlabbeq r7,r5,r3,r7
ldr r5,[r14],#-4
ldrsh r11,[r1,#-4]
subeq r12,r12,#2
LoopInner:
...
movs r4,r4
ldreqsh r3,[r1,#-2]
smlatbeq r8,r5,r11,r8
ldreqsh r11,[r1,#2]
smlatbeq r9,r5,r3,r9
ldreqsh r3,[r1],-r2
smlatbeq r10,r5,r11,r10
str r8,[r0]
smlatbeq r7,r5,r3,r7
str r9,[r0,#4]
str r7,[r0,#8]
str r10,[r0,#12]
