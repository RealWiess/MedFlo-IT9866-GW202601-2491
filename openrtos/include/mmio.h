...
#define GENERAL_USER_DEFINED_REG_BASE             0xD8000220U
#define RISC_USER_DEFINED_REG_BASE                0xB0200080U
#define USER_DEFINE_REG0                          (GENERAL_USER_DEFINED_REG_BASE + 0x00U)
#define USER_DEFINE_REG1                          (GENERAL_USER_DEFINED_REG_BASE + 0x04U)
#define USER_DEFINE_REG2                          (GENERAL_USER_DEFINED_REG_BASE + 0x08U)
#define USER_DEFINE_REG3                          (GENERAL_USER_DEFINED_REG_BASE + 0x0CU)
#define USER_DEFINE_REG4                          (GENERAL_USER_DEFINED_REG_BASE + 0x10U)
#define USER_DEFINE_REG5                          (GENERAL_USER_DEFINED_REG_BASE + 0x14U)
#define USER_DEFINE_REG6                          (GENERAL_USER_DEFINED_REG_BASE + 0x18U)
#define USER_DEFINE_REG7                          (GENERAL_USER_DEFINED_REG_BASE + 0x1CU)
#define USER_DEFINE_REG8                          (GENERAL_USER_DEFINED_REG_BASE + 0x20U)
#define USER_DEFINE_REG9                          (GENERAL_USER_DEFINED_REG_BASE + 0x24U)
#define USER_DEFINE_REG10                         (GENERAL_USER_DEFINED_REG_BASE + 0x28U)
#define USER_DEFINE_REG11                         (GENERAL_USER_DEFINED_REG_BASE + 0x2CU)
#define USER_DEFINE_REG12                         (GENERAL_USER_DEFINED_REG_BASE + 0x30U)
#define USER_DEFINE_REG13                         (GENERAL_USER_DEFINED_REG_BASE + 0x34U)
#define USER_DEFINE_REG14                         (GENERAL_USER_DEFINED_REG_BASE + 0x38U)
#define USER_DEFINE_REG15                         (GENERAL_USER_DEFINED_REG_BASE + 0x3CU)
#define USER_DEFINE_REG16                         (GENERAL_USER_DEFINED_REG_BASE + 0x40U)
#define USER_DEFINE_REG17                         (GENERAL_USER_DEFINED_REG_BASE + 0x44U)
#define USER_DEFINE_REG18                         (GENERAL_USER_DEFINED_REG_BASE + 0x48U)
#define USER_DEFINE_REG19                         (GENERAL_USER_DEFINED_REG_BASE + 0x4CU)
#define USER_DEFINE_REG20                         (GENERAL_USER_DEFINED_REG_BASE + 0x50U)
#define USER_DEFINE_REG21                         (GENERAL_USER_DEFINED_REG_BASE + 0x54U)
#define USER_DEFINE_REG22                         (GENERAL_USER_DEFINED_REG_BASE + 0x58U)
#define USER_DEFINE_REG23                         (GENERAL_USER_DEFINED_REG_BASE + 0x5CU)
#define USER_DEFINE_REG24                         (RISC_USER_DEFINED_REG_BASE + 0x00U)
#define USER_DEFINE_REG25                         (RISC_USER_DEFINED_REG_BASE + 0x04U)
#define USER_DEFINE_REG26                         (RISC_USER_DEFINED_REG_BASE + 0x08U)
#define USER_DEFINE_REG27                         (RISC_USER_DEFINED_REG_BASE + 0x0CU)
#define USER_DEFINE_REG28                         (RISC_USER_DEFINED_REG_BASE + 0x10U)
#define USER_DEFINE_REG29                         (RISC_USER_DEFINED_REG_BASE + 0x14U)
#define USER_DEFINE_REG30                         (RISC_USER_DEFINED_REG_BASE + 0x18U)
#define USER_DEFINE_REG31                         (RISC_USER_DEFINED_REG_BASE + 0x1CU)
#define USER_DEFINE_REG32                         (RISC_USER_DEFINED_REG_BASE + 0x20U)
#define USER_DEFINE_REG33                         (RISC_USER_DEFINED_REG_BASE + 0x24U)
#define USER_DEFINE_REG34                         (RISC_USER_DEFINED_REG_BASE + 0x28U)
#define USER_DEFINE_REG35                         (RISC_USER_DEFINED_REG_BASE + 0x2CU)
...
/* Control bit for Audio Reset (DrvAudioCtrl2 register) */
#define DrvAudio_RESET                     (1U << DrvAudio_Reset_Bits)  // D[15]
...
/////////////////////////////////////////////////////////////////
    ...
    /* For MMIO interface */
    #define MMIO_ADDR 0xC0000000U
#elif defined(CFG_CHIP_REV_AW2)
    #define MMIO_ADDR 0xC0200000U
#else
    #define MMIO_ADDR 0xC0200000U
#endif

/* For Soft Interrupt to Host */
#define MMIO_MISC     0x80000024U
...
#define MMIO_INT      (1 << 16)
    ...
    #define getAC32ChDownmixMode()                                                                                     \
        ((MMIO_Read(AC3_DECODER_PARAMETER) & AC3_2_CHANNELS_DOWNMIX_MODE) >> AC3_2_CHANNELS_DOWNMIX_MODE_BITS)
    /* Flash audio input Parameter */
    // format 1:mp3 ,2 wav
    #define getFlashInput0Format()                                                                                     \
        ((MMIO_Read(FLASH_AUDIO_INPUT_PARAMETER) & FLASH_INPUT_0_FORMAT) >> FLASH_AUDIO_INPUT_0_BIT) + 1
    #define getFlashInput1Format()                                                                                     \
        ((MMIO_Read(FLASH_AUDIO_INPUT_PARAMETER) & FLASH_INPUT_1_FORMAT) >> FLASH_AUDIO_INPUT_1_BIT) + 1
    #define getFlashInput2Format()                                                                                     \
        ((MMIO_Read(FLASH_AUDIO_INPUT_PARAMETER) & FLASH_INPUT_2_FORMAT) >> FLASH_AUDIO_INPUT_2_BIT) + 1
    #define getFlashInput3Format()                                                                                     \
        ((MMIO_Read(FLASH_AUDIO_INPUT_PARAMETER) & FLASH_INPUT_3_FORMAT) >> FLASH_AUDIO_INPUT_3_BIT) + 1
    #define getFlashInput0Using()                                                                                      \
        ((MMIO_Read(FLASH_AUDIO_INPUT_PARAMETER) & FLASH_INPUT_0_USING) >> FLASH_AUDIO_INPUT_0_USING_BIT)
    #define getFlashInput1Using()                                                                                      \
        ((MMIO_Read(FLASH_AUDIO_INPUT_PARAMETER) & FLASH_INPUT_1_USING) >> FLASH_AUDIO_INPUT_1_USING_BIT)
    #define getFlashInput2Using()                                                                                      \
        ((MMIO_Read(FLASH_AUDIO_INPUT_PARAMETER) & FLASH_INPUT_2_USING) >> FLASH_AUDIO_INPUT_2_USING_BIT)
    #define getFlashInput3Using()                                                                                      \
        ((MMIO_Read(FLASH_AUDIO_INPUT_PARAMETER) & FLASH_INPUT_3_USING) >> FLASH_AUDIO_INPUT_3_USING_BIT)
