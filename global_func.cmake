...
function(ITE_ADD_DRIVER_SOURCE_FILE lib)
    ...
    file(RELATIVE_PATH rel_path "${sdk_path}" "${CMAKE_CURRENT_SOURCE_DIR}")
    set(chip_path "${CMAKE_SOURCE_DIR}/sdk/chip/it${CFG_CHIP_FAMILY}/${rel_path}")

    foreach(in_file ${ARGN})
        set(file_path "${chip_path}/${in_file}")
        if (EXISTS ${file_path})
