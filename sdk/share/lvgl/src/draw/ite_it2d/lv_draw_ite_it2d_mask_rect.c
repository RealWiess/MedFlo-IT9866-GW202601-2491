/**
 * @file lv_draw_ite_it2d_mask_rect.c
 *
 */
                                ...
                                const lv_area_t * coords)
{
    ...
    ite_it2d_surface_t * dstsurf = lv_layer_get_ite_it2d_surface(target_layer);
    ite_it2d_wait_surface_finish(dstsurf);
    lv_sys_cache_data_invd_range(dstsurf->buf, dstsurf->pitch * dstsurf->height);
    ...
    lv_sys_cache_data_flush_range(dstsurf->buf, dstsurf->pitch * dstsurf->height);
}
