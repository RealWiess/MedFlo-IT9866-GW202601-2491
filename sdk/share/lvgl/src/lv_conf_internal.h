...
/** Draw using ITE IT2D */
#ifndef LV_USE_DRAW_ITE_IT2D
    #ifdef CONFIG_LV_USE_DRAW_ITE_IT2D
        #define LV_USE_DRAW_ITE_IT2D CONFIG_LV_USE_DRAW_ITE_IT2D
    #else
        #define LV_USE_DRAW_ITE_IT2D 0
    #endif
#endif

#if LV_USE_DRAW_ITE_IT2D
    #ifndef LV_ITE_IT2D_INCLUDE_PATH
        #ifdef CONFIG_LV_ITE_IT2D_INCLUDE_PATH
            #define LV_ITE_IT2D_INCLUDE_PATH CONFIG_LV_ITE_IT2D_INCLUDE_PATH
        #else
            #define LV_ITE_IT2D_INCLUDE_PATH "ite_it2d.h"
        #endif
    #endif

    /** ITE IT2D cache size of draw to surface. */
    #ifndef LV_ITE_IT2D_CACHE_SIZE
        #ifdef CONFIG_LV_ITE_IT2D_CACHE_SIZE
            #define LV_ITE_IT2D_CACHE_SIZE CONFIG_LV_ITE_IT2D_CACHE_SIZE
        #else
            #define LV_ITE_IT2D_CACHE_SIZE 4194304
        #endif
    #endif

    /** ITE IT2D LRU size of surface cache. */
    #ifndef LV_ITE_IT2D_LRU_SIZE
        #ifdef CONFIG_LV_ITE_IT2D_LRU_SIZE
            #define LV_ITE_IT2D_LRU_SIZE CONFIG_LV_ITE_IT2D_LRU_SIZE
        #else
            #define LV_ITE_IT2D_LRU_SIZE 4194304
        #endif
    #endif

    /** Use ITE IT2D to rotate display.*/
    #ifndef LV_USE_ROTATE_ITE_IT2D
        #ifdef CONFIG_LV_USE_ROTATE_ITE_IT2D
            #define LV_USE_ROTATE_ITE_IT2D CONFIG_LV_USE_ROTATE_ITE_IT2D
        #else
            #define LV_USE_ROTATE_ITE_IT2D 0
        #endif
    #endif
#endif
...
/*ITG decoder library*/
#ifndef LV_USE_ITG
    #ifdef CONFIG_LV_USE_ITG
        #define LV_USE_ITG CONFIG_LV_USE_ITG
    #else
        #define LV_USE_ITG 0
    #endif

    #ifdef CONFIG_LV_USE_ITG_SW
        #define LV_USE_ITG_SW CONFIG_LV_USE_ITG_SW
    #else
        #define LV_USE_ITG_SW 0
    #endif
#endif
