...
void lv_example_xml_2(void)
{
    ...
    res = lv_xml_component_register_from_file("A:A:/my_h3.xml");
    if(res != LV_RESULT_OK) {
    ...
    lv_xml_component_register_from_file("A:A:/my_card.xml");
    //lv_xml_component_register_from_file("A:lvgl/examples/others/xml/my_button.xml");
    lv_xml_component_register_from_file("A:A:/my_button.xml");
    //lv_xml_component_register_from_file("A:lvgl/examples/others/xml/view.xml");
    lv_xml_component_register_from_file("A:A:/view.xml");
