 ...
 */
void lv_example_ffmpeg_raw(void)
{
    ...
    lv_obj_t * player = lv_ffmpeg_raw_create(lv_screen_active());
    lv_ffmpeg_raw_set_src(player, "A:/test.264", 1280, 480, 640, 480, 33);
    lv_ffmpeg_raw_set_cmd(player, LV_FFMPEG_RAW_CMD_START);
...
void lv_example_ffmpeg_2(void)
{
    ...
    lv_ffmpeg_player_set_src(player, "A:/test.mp4", 1280, 480);
