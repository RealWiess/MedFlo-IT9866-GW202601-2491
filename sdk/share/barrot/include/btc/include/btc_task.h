 ...
 *                   others: fail
 */
bt_status_t btc_transfer_context(btc_msg_t *msg, void *arg, unsigned int arg_len, btc_arg_deep_copy_t copy_func);
 ...
 */
pthread_t *btc_get_current_thread(void);
