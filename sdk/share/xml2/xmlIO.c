...
#if defined(_WIN32)
#ifndef WIN32_LEAN_AND_MEAN/*ite*/
...
/*ite*/
    ...
    #define xmlMalloc(s)        Rmalloc((s), RM_FILE_POS)
    #define xmlMallocAtomic(s)  Rmalloc((s), RM_FILE_POS)
    #define xmlRealloc(p,s)     Rrealloc((p), (s), RM_FILE_POS)
    #define xmlFree(p)          Rfree((p), RM_FILE_POS)
    #define xmlMemStrdup(s)     Rstrdup((s), RM_FILE_POS)
#endif
