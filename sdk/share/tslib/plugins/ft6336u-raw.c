 ...
 */ 
static int ft6336u_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops ft6336u_ops =
{
	ft6336u_read,
};

TSAPI struct tslib_module_info *ft6336u_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(ft6336u_mod_init);
#endif
