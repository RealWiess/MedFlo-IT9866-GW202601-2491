 ...
 */ 
static int ft7251_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops ft7251_ops =
{
	ft7251_read,
};

TSAPI struct tslib_module_info *ft7251_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(ft7251_mod_init);
#endif
