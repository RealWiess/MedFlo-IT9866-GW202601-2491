 ...
 */ 
static int ft7511_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops ft7511_ops =
{
	ft7511_read,
};

TSAPI struct tslib_module_info *ft7511_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(ft7511_mod_init);
#endif
