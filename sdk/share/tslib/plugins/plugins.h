...
TSLIB_DECLARE_MODULE(chsc6540);
TSLIB_DECLARE_MODULE(cst816s);
...
TSLIB_DECLARE_MODULE(ft6336u);
TSLIB_DECLARE_MODULE(ft6436);
TSLIB_DECLARE_MODULE(ft7251);
TSLIB_DECLARE_MODULE(ft7511);
TSLIB_DECLARE_MODULE(ga6571);
TSLIB_DECLARE_MODULE(gt911);
TSLIB_DECLARE_MODULE(gt928);
TSLIB_DECLARE_MODULE(gt5688);
TSLIB_DECLARE_MODULE(gt9271);
TSLIB_DECLARE_MODULE(gsl1680);
