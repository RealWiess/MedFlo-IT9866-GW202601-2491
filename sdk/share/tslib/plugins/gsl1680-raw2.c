...
application notes:
 1.LOAD GSL1680's F/W will spend about 697ms(@I2C CLOCK=400KHZ)
 2.KCONFIG set "GPIO:Touch Reset Pin:"
 3.KCONFIG select "GPIO:Touch INT Pin Active High:"
 4.KCONFIG set "Peripheral:Touch Enable:The Maximum of Native X Value: 0x27F"
...
static void _GSLX680_load_fw(void)
{
	...
	SCI_TRACE_LOW("[TP]_GSL1680_load_fw end========== [%d ms]\n",tD);
}
 ...
 */ 
static int gsl1680_read(struct tslib_module_info *inf, struct ts_sample *samp, int nr)
{
...
static const struct tslib_ops gsl1680_ops =
{
	gsl1680_read,
};

TSAPI struct tslib_module_info *gsl1680_mod_init(struct tsdev *dev, const char *params)
{
	...
	TSLIB_MODULE_INIT(gsl1680_mod_init);
#endif
