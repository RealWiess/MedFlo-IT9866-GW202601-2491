...
#define OBX_SRMP_CL_FINAL   0x02    /* handle GET Response final with SRMP=1 (used by client only) */
#define OBX_SRMP_WAITING_CLEARED 0x04 /* Receiving SRMP=1 while SRM is enabled, wait peer to clear SRMP */
