...
bool _NOR_cache_writeExistedPartialSector (NOR_CACHE* cache, const void* buffer, sec_t sector, unsigned int offset, size_t size, bool writeThrough);

bool _NOR_cache_readExistedPartialSector (NOR_CACHE* cache, void* buffer, sec_t sector, unsigned int offset, size_t size);

void _NOR_cache_invalidateSector (NOR_CACHE* cache, sec_t sector);
#endif // _CACHE_H
