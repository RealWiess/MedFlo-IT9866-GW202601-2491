#ifndef _MMCSD_CACHE2_H
#define _MMCSD_CACHE2_H
...
typedef bool (* FN_MEDIUM_READSECTORS)(void* drvInfo,sec_t sector, sec_t numSectors, void* buffer) ;
typedef bool (* FN_MEDIUM_WRITESECTORS)(void* drvInfo, sec_t sector, sec_t numSectors, const void* buffer) ;
...
*/
bool _MMCSD_cache_readSectors (MMCSD_CACHE* NOR_CACHE, sec_t sector, sec_t numSectors, void* buffer);
...
bool _MMCSD_cache_writeSectors (MMCSD_CACHE* NOR_CACHE, sec_t sector, sec_t numSectors, const void* buffer);

/*
Write any dirty sectors back to disc and clear out the contents of the NOR_CACHE
*/
bool _MMCSD_cache_flush (MMCSD_CACHE* NOR_CACHE);

/*
Clear out the contents of the NOR_CACHE without writing any dirty sectors first
*/
void _MMCSD_cache_invalidate (MMCSD_CACHE* NOR_CACHE);
...
void _MMCSD_cache_destructor (MMCSD_CACHE* NOR_CACHE);
