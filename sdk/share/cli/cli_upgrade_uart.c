...
static portBASE_TYPE prvTaskUartBootCommand (char *       pcWriteBuffer,
...
static portBASE_TYPE prvTaskUartUplaodCommand (char *       pcWriteBuffer,
                                               size_t       xWriteBufferLen,
                                               const char * pcCommandString)
{
...
static portBASE_TYPE prvTaskUartUpgradeCommand (char *       pcWriteBuffer,
                                                size_t       xWriteBufferLen,
                                                const char * pcCommandString)
{
...
#ifdef CFG_NET_TFTP
static portBASE_TYPE prvTaskUartTftpUpgradeCommand (
...
static const xCommandLineInput xTaskUartUploadCommand = {
    ...
    (const char * const)"uart_upload <size>: Upload package file with "
                        "specified size. UART only.\r\n",
...
static const xCommandLineInput xTaskUartTftpUpgradeCommand = {
    ...
    (const char * const)"uart_tftp_upgrade: Download pkg from tftp serve and "
                        "upgrade system.\r\n",
