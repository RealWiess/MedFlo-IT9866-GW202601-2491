...
static const xCommandLineInput xTaskStatsCommand = {
    ...
    (const char * const)"task-stats: Displays a table showing the state of "
                        "each FreeRTOS task\r\n",
    prvTaskStatsCommand,
    0
};
...
static const xCommandLineInput xRunTimeStatsCommand = {
    ...
    (const char * const)"run-time-stats: Displays a table showing how much "
                        "processing time each FreeRTOS task has used\r\n",
