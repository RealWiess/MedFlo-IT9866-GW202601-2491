...
static portBASE_TYPE prvTaskWriteFileCommand (char *       pcWriteBuffer,
                                              ...
                                              const char * pcCommandString)
{
    ...
    if (xReady == pdFALSE)
    {
        ...
        CLI_LOG_DBG("%s: size=%u\n", pcParameter1, filesize);
...
static const xCommandLineInput xWriteFileCommand = {
    ...
    (const char * const)"write-file <filepath> <size>: Writes file to "
                        "specified path with size. USB ACM only.\r\n",
