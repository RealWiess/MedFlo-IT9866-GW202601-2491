...
#define LX_DISABLE                              FX_DISABLE_INTS
#define LX_RESTORE                              FX_RESTORE_INTS
...
typedef struct LX_NOR_FLASH_STRUCT
{
    ...
    ULONG                           *lx_nor_flash_mapping_map;
} LX_NOR_FLASH;
...
#define lx_nor_flash_open_with_cache                    _lx_nor_flash_open_with_cache
#endif
...
UINT    _lx_nor_flash_logical_sector_find(LX_NOR_FLASH *nor_flash, ULONG logical_sector, ULONG superceded_check, ULONG **physical_sector_map_entry, ULONG **physical_sector_address, ULONG *phy_block, ULONG *phy_sec);
...
UINT  _lx_nor_flash_physical_sector_allocate(LX_NOR_FLASH *nor_flash, ULONG logical_sector, ULONG **physical_sector_map_entry, ULONG **physical_sector_address, ULONG *phy_block, ULONG *phy_sec);
