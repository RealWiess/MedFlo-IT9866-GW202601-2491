                ...
                for (k = 0; k < 32; k++)
                {
                    ...
                    if (block_word & 1)
                    {
                        ...
                        if (((block_word >> 1) == 0) && (j == (nor_flash -> lx_nor_flash_block_bit_map_words - 1)))
                        {
                            ...
                            mapping_buf_ptr = nor_flash->lx_nor_flash_mapping_map + search_block * nor_flash -> lx_nor_flash_physical_sectors_per_block;
                        ...
                        *phy_block = (ULONG)(block_word_ptr - nor_flash -> lx_nor_flash_base_address) / nor_flash -> lx_nor_flash_words_per_block;
                        *phy_sec = j*32 + k;
                        /* Return success!  */
                        return(LX_SUCCESS);                     
                    }
