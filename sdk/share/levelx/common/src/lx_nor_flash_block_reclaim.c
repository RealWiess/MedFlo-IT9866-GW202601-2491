...
ULONG phy_sec;
    ...
    if (obsolete_sectors == nor_flash -> lx_nor_flash_physical_sectors_per_block)
    {
        ...
        mapping_buf_ptr = nor_flash->lx_nor_flash_mapping_map + erase_block * nor_flash -> lx_nor_flash_physical_sectors_per_block;
        memset(mapping_buf_ptr, 0xFF, nor_flash -> lx_nor_flash_physical_sectors_per_block * sizeof(ULONG));
                ...
                if (list_word & LX_NOR_PHYSICAL_SECTOR_VALID)
                {
                    ...
                    if (new_mapping_address)
                    {
                        ...
                        *mapping_buf_ptr = list_word;
                        ...
                        new_mapping_buf_ptr = nor_flash->lx_nor_flash_mapping_map + phy_block * nor_flash -> lx_nor_flash_physical_sectors_per_block + phy_sec;
                        *new_mapping_buf_ptr = new_mapping_entry;
