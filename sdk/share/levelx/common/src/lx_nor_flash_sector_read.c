...
ULONG   *mapping_buf_ptr;
    ...
    _lx_nor_flash_logical_sector_find(nor_flash, logical_sector, LX_FALSE, &mapping_address, &sector_address, &phy_block, &phy_sec);
    ...
    else
    {
        ...
        _lx_nor_flash_physical_sector_allocate(nor_flash, logical_sector, &mapping_address, &sector_address, &phy_block, &phy_sec);
