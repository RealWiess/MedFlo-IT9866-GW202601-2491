...
VOID  _fx_system_initialize(VOID)
{
    ...
    _fx_system_timer = FX_SYSTEM_TIMER;
    ITHIntr irqn = _fx_system_timer <= ITH_TIMER8 ? ITH_INTR_TIMER1 + _fx_system_timer : ITH_INTR_TIMER9 + _fx_system_timer - ITH_TIMER9;
            
    ithTimerReset(_fx_system_timer);
    ...
    ithIntrRegisterHandlerIrq(irqn, _fx_system_timer_entry, (void *)_fx_system_timer);
    ...
    ithTimerSetTimeout(_fx_system_timer, FX_UPDATE_RATE_IN_TICKS*1000);
    ithTimerEnable(_fx_system_timer);
#endif
