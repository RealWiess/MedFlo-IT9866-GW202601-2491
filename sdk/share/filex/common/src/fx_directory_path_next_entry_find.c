...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _fx_directory_path_next_entry_find                  PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*    directory_name                        Return for search directory   */
/*                                            name                        */
/*                                                                        */
/*  OUTPUT                                                                */
/*                                                                        */
...
/*                                                                        */
/**************************************************************************/
UINT  _fx_directory_path_next_entry_find(FX_MEDIA *media_ptr, FX_PATH *search_path, CHAR *directory_name)
{
...
CHAR         *path_string_ptr =  FX_NULL;
    ...
    if (search_path->fx_path_directory.fx_dir_entry_name[0])
    {

        /* Setup the path pointer to the input path.  */
        path_ptr =  search_path;        
#ifndef FX_MEDIA_DISABLE_SEARCH_CACHE

        /* Setup pointer to the path.  */
        path_string_ptr =  search_path->fx_path_string;
#endif
