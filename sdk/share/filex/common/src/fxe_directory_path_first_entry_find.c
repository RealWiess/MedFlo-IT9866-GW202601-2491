...
/*  FUNCTION                                               RELEASE        */
/*                                                                        */
/*    _fxe_directory_path_first_entry_find                PORTABLE C      */
/*                                                           6.1          */
/*  AUTHOR                                                                */
/*                                                                        */
...
/*  CALLS                                                                 */
/*                                                                        */
/*    _fx_directory_path_first_entry_find   Actual first find service     */
/*                                                                        */
/*  CALLED BY                                                             */
/*                                                                        */
/*    Application Code                                                    */
...
/*                                                                        */
/**************************************************************************/
UINT  _fxe_directory_path_first_entry_find(FX_MEDIA *media_ptr, FX_PATH *search_path, CHAR *directory_name)
{
...
UINT status;
    ...
    status =  _fx_directory_path_first_entry_find(media_ptr, search_path, directory_name);
