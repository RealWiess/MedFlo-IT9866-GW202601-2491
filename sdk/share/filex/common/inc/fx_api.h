...
#ifndef FX_SINGLE_THREAD
#define FX_LOCAL_PATH_SETUP     extern pthread_t *_tx_thread_current_ptr;
#else
#define FX_NO_LOCAL_PATH
#endif
#endif
...
typedef struct FX_MEDIA_STRUCT
{
    ...
    /* Define the media's protection object, which is a ThreadX mutex.
       ...
       not needed.  */
#ifndef FX_SINGLE_THREAD
    pthread_mutex_t             fx_media_protect;
#endif
...
{   
   ...
   void *wearCache;
   ULONG wearCacheSize;
   void *wearBuf;    // LevelX need one sector size buffer.
   UCHAR eraseReq;   // The driver will erase first during the initialization process, and clean this flag after erase.
} LX_DRV_INFO;
#endif
...
#define fx_directory_path_set                 _fx_directory_path_set
#define fx_directory_path_first_entry_find    _fx_directory_path_first_entry_find
#define fx_directory_path_next_entry_find     _fx_directory_path_next_entry_find
...
#define fx_driver                             _fx_driver
#define fx_nor_flash_lx_driver                _fx_nor_flash_lx_driver
#define fx_directory_path_set                 _fxe_directory_path_set
#define fx_directory_path_first_entry_find    _fxe_directory_path_first_entry_find
#define fx_directory_path_next_entry_find     _fxe_directory_path_next_entry_find
#endif
...
UINT fx_media_format(FX_MEDIA *media_ptr, VOID (*driver)(FX_MEDIA *media), VOID *driver_info_ptr, UCHAR *memory_ptr, UINT memory_size,
                     ...
                     UINT heads, UINT sectors_per_track, UINT reserved_sectors);
#ifdef FX_ENABLE_EXFAT
...
UINT    fx_directory_path_set(FX_MEDIA *media_ptr, FX_PATH *search_path, CHAR *new_path_name);
UINT    fx_directory_path_first_entry_find(FX_MEDIA *media_ptr, FX_PATH *search_path, CHAR *directory_name);
UINT    fx_directory_path_next_entry_find(FX_MEDIA *media_ptr, FX_PATH *search_path, CHAR *directory_name);
#endif
