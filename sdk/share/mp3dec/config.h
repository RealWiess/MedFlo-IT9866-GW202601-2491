...
#endif
//FLAC
#if defined(CFG_AUDIO_CODEC_FLACDEC) || defined(CFG_FFMPEG_AUDIO_DECODE)
...
#else
    #if defined(CFG_AUDIO_CODEC_MP3DEC) || defined(CFG_FFMPEG_AUDIO_DECODE)
        #define CONFIG_MP3_DECODER           1
    #else
...
#define CONFIG_TLS_PROTOCOL                  0
    ...
    #define CONFIG_TSMIRACAST_PROTOCOL       1 /* iTE miracast */
#endif
#else
    #define CONFIG_UDP_PROTOCOL              0
	#define CONFIG_TSMIRACAST_PROTOCOL       0 /* iTE miracast */
