...
static int mp_decode_layer1(MPADecodeContext *s)
{
    ...
    uint8_t scale_factors[MPA_MAX_CHANNELS][SBLIMIT]={0};
...
static int mp_decode_layer2(MPADecodeContext *s)
{
    ...
    unsigned char scale_code[MPA_MAX_CHANNELS][SBLIMIT]={0};
    unsigned char scale_factors[MPA_MAX_CHANNELS][SBLIMIT][3]={0}, *sf;
                           ...
                           const uint8_t *buf, int buf_size)
{
    ...
    if (!samples) {
        ...
        sizebytes=s->frame.nb_samples*s->nb_channels*2;
		#if 0
		...
		#else
		if(sizebytes>s->frame.linesize[0]){
			s->frame.data[0] = av_realloc(s->frame.data[0],sizebytes);
        }
		#endif
