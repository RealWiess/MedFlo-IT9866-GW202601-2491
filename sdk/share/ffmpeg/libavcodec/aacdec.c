                                ...
                                int *got_frame_ptr, GetBitContext *gb)
{
    ...
    if (samples) {
		...
		ac->frame.linesize[0] = avctx->frame_size*avctx->channels*2;
    ...
    *got_frame_ptr = !!samples;
	...
	if(ac->m4ac.sbr != 1 && ac->m4ac.ps != 1)
		avctx->aac_spec = LC_AAC;
	else if(ac->m4ac.sbr == 1 && ac->m4ac.ps != 1)
		avctx->aac_spec = HE_AAC;
	else if(ac->m4ac.sbr == 1 && ac->m4ac.ps == 1)
		avctx->aac_spec = HE_AAC_V2;
