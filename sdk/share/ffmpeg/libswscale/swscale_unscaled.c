...
#if defined(WIN32)
            {
                const uint8_t* arr1[] = {src[1], src[0], src[2]};
                int arr2[] = {srcStride[1], srcStride[0], srcStride[2]};
                gbr24ptopacked24(arr1, arr2,
...
#if defined(WIN32)
            {
                const uint8_t* arr1[] = {src[2], src[0], src[1]};
                int arr2[] = {srcStride[2], srcStride[0], srcStride[1]};
                gbr24ptopacked24(arr1, arr2,
                      dst[0] + srcSliceY * dstStride[0], dstStride[0], srcSliceH, c->srcW);
            }
#else
