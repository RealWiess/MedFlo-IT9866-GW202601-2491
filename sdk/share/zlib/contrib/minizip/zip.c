...
local int zip64local_getByte(const zlib_filefunc64_32_def* pzlib_filefunc_def, voidpf filestream, int* pi) {
    unsigned char c = 0;/*[ite]fix coverity UNINIT*/
...
local ZPOS64_T zip64local_SearchCentralDir(const zlib_filefunc64_32_def* pzlib_filefunc_def, voidpf filestream) {
  ...
  memset(buf, 0, BUFREADCOMMENT + 4); /*[ite]fix coverity UNINIT*/  
...
*/
...

  {
    ...
    /*[ite]fix coverity UNINIT*/
    if (buf_read == NULL) {
        err = ZIP_ERRNO;
        return err;
    }
    memset(buf_read, 0, buf_size); /*[ite]fix coverity UNINIT*/
...
extern zipFile ZEXPORT zipOpen3(const void *pathname, int append, zipcharpc* globalcomment, zlib_filefunc64_32_def* pzlib_filefunc64_32_def) {
    zip64_internal ziinit = {0};/*[ite]fix coverity UNINIT*/
    zip64_internal* zi;
    int err=ZIP_OK;
...
extern zipFile ZEXPORT zipOpen2(const char *pathname, int append, zipcharpc* globalcomment, zlib_filefunc_def* pzlib_filefunc32_def) {
    ...
    {
        zlib_filefunc64_32_def zlib_filefunc64_32_def_fill = {0};/*[ite]fix coverity UNINIT*/
