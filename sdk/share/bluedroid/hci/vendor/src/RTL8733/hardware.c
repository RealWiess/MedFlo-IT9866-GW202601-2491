...
#include "rtl8733bs_config.c"
#include "rtl8733bs_fw.c"
...
//signature: realtech
const uint8_t RTK_EPATCH_SIGNATURE[8] = {0xB2, 0xC7, 0x41, 0x91, 0x89, 0x74, 0x0E, 0xEB};
const uint8_t EXTENSION_SECTION_SIGNATURE[4] = {0xFA, 0x26, 0x72, 0x69};
