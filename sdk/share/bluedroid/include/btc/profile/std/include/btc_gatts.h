...
typedef union {
    ...
    struct create_attr_tab_args{
        ...
        uint8_t max_nb_attr;
        bd_gatts_attr_db_t *gatts_attr_db;
    }create_attr_tab;
    ...
    struct add_char_args {
        ...
        bd_gatt_perm_t perm;
        bd_gatt_char_prop_t property;
        bd_attr_control_t attr_control;
        bd_attr_value_t char_val;
    } add_char;
...
bd_gatt_status_t btc_gatts_get_attr_value(uint16_t attr_handle, uint16_t *length, uint8_t **value);
