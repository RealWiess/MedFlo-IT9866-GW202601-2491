...
#include "api/bd_a2dp_api.h"
#include "btc/include/btc_task.h"
#include "btc/include/btc_common.h"
#include "btc/include/btc_sm.h"
...
typedef union {
    ...
    bt_bdaddr_t disconn;
    // BTC_AV_SINK_API_REG_DATA_CB_EVT
    bd_a2d_sink_data_cb_t data_cb;
#endif  /* BTC_AV_SINK_INCLUDED */
#if BTC_AV_SRC_INCLUDED
    // BTC_AV_SRC_API_REG_DATA_CB_EVT
    bd_a2d_source_data_cb_t src_data_cb;
...
void btc_a2dp_sink_reg_data_cb(bd_a2d_sink_data_cb_t callback);

void btc_a2dp_src_reg_data_cb(bd_a2d_source_data_cb_t callback);
/*******************************************************************************
**
