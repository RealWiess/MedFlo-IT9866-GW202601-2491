...
#include "btc/include/btc_task.h"
...
typedef union {
    ...
    struct app_unreg_arg {
        bd_gatt_if_t gattc_if;
    } app_unreg;
    //BTC_GATTC_ACT_OPEN,
    struct open_arg {
        bd_gatt_if_t gattc_if;
        bd_addr_t remote_bda;
        bd_ble_addr_type_t remote_addr_type;
        bool is_direct;
    } open;
    //BTC_GATTC_ACT_CLOSE,
    struct close_arg {
    ...
    struct read_multiple_arg {
        uint16_t conn_id;
        uint8_t  num_attr;
        uint16_t handles[BD_GATT_MAX_READ_MULTI_HANDLES];
        bd_gatt_auth_req_t auth_req;
    } read_multiple;
    //BTC_GATTC_ACT_READ_CHAR_DESCR,
...
bd_gatt_status_t btc_ble_gattc_get_service(uint16_t conn_id, bd_bt_uuid_t *svc_uuid, 
                                            bd_gattc_service_elem_t *result,
                                            uint16_t *count, uint16_t offset);
bd_gatt_status_t btc_ble_gattc_get_all_char(uint16_t conn_id,
                                             uint16_t start_handle,
                                             uint16_t end_handle,
                                             bd_gattc_char_elem_t *result,
                                             uint16_t *count, uint16_t offset);
bd_gatt_status_t btc_ble_gattc_get_all_descr(uint16_t conn_id,
                                              uint16_t char_handle,
                                              bd_gattc_descr_elem_t *result,
                                              uint16_t *count, uint16_t offset);
bd_gatt_status_t btc_ble_gattc_get_char_by_uuid(uint16_t conn_id,
                                                 uint16_t start_handle,
                                                 uint16_t end_handle,
                                                 bd_bt_uuid_t char_uuid,
                                                 bd_gattc_char_elem_t *result,
                                                 uint16_t *count);
bd_gatt_status_t btc_ble_gattc_get_descr_by_uuid(uint16_t conn_id,
                                                  uint16_t start_handle,
                                                  uint16_t end_handle,
                                                  bd_bt_uuid_t char_uuid,
...
bd_gatt_status_t btc_ble_gattc_get_descr_by_char_handle(uint16_t conn_id,
                                                         uint16_t char_handle,
                                                         bd_bt_uuid_t descr_uuid,
                                                         bd_gattc_descr_elem_t *result,
                                                         uint16_t *count);

bd_gatt_status_t btc_ble_gattc_get_include_service(uint16_t conn_id,
                                                    uint16_t start_handle,
                                                    uint16_t end_handle,
...
bd_gatt_status_t btc_ble_gattc_get_attr_count(uint16_t conn_id,
...
bd_gatt_status_t btc_ble_gattc_get_db(uint16_t conn_id, uint16_t start_handle, uint16_t end_handle, 
