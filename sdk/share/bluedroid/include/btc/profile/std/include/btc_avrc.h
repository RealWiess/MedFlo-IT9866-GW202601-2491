...
#define BTC_AVRC_MIN_VOLUME 0x00U
#define BTC_AVRC_MAX_VOLUME 0x7fU
...
#define BTC_RC_CT_INIT_MAGIC            0
#define BTC_RC_TG_INIT_MAGIC            1

#define MAX_RC_NOTIFICATIONS            (13)  // refer to bd_AVRC_RN_MAX_EVT


#define CHECK_BD_RC_CONNECTED       do { \
