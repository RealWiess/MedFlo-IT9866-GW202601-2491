...
void uuid128_be_to_bd_uuid(bd_bt_uuid_t *u, uint8_t* uuid128);

void uuid_to_string_legacy(bt_uuid_t *p_uuid, char *str);

bd_bt_status_t btc_hci_to_bd_status(uint8_t hci_status);
bd_bt_status_t btc_btm_status_to_bd_status (uint8_t btm_status);
