...
extern buffer_t *l2cap_buffer_new(size_t size);
...
extern l2cap_client_t *l2cap_client_new(const l2cap_client_callbacks_t *callbacks, void *context);

// Frees the L2CAP client object allocated with |l2cap_client_new|. |client| may be NULL.
extern void l2cap_client_free(l2cap_client_t *client);
...
extern bool l2cap_client_connect(l2cap_client_t *client, const bt_bdaddr_t *remote_bdaddr, uint16_t psm);
...
extern void l2cap_client_disconnect(l2cap_client_t *client);

// Returns true if |client| is connected and is ready to accept data written to it.
// |client| must not be NULL.
extern bool l2cap_client_is_connected(const l2cap_client_t *client);
...
extern bool l2cap_client_write(l2cap_client_t *client, buffer_t *packet);
