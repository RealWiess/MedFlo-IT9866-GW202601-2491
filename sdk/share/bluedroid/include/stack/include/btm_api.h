...
#include "include/common/bt_target.h"
#include "include/stack/include/hcidefs.h"

#if SDP_INCLUDED == TRUE
#include "include/stack/include/sdp_api.h"
#endif

#if SMP_INCLUDED == TRUE
#include "include/stack/include/smp_api.h"
#endif
/*****************************************************************************
...
*****************************************************************************/
#define BTM_REMOTE_BD_DISCONNECTED              0
#define BTM_REMOTE_BD_CONNECTED                 1
#define BTM_REMOTE_BD_UNSTABLE_LINK_STATUS      -1
...
/*******************************************************************************
**
** Function         BTM_GetConnectStatus(BD_ADDR remote_bda)
**
** Description      This function is called to obtain the BR/ED controller connect status
**
** Parameter
**                  input:        
**                  remote_bda: desired search remote peer bd address.
**
**                  output:
**                  pDiscReason: disconnection reason.
**                               -1 - No such connection ever.
**                                0  - Normal disconnect reason. (Peer call disconnect)
**                                > 0 - disconnect reason. (check hcidefs.h)
** Returns          
**                   BTM_REMOTE_BD_CONNECTED            - Connected 
**                   BTM_REMOTE_BD_DISCONNECTED         - Disconnected
**                   BTM_REMOTE_BD_UNSTABLE_LINK_STATUS - Unstable connection (connecting, disconneting)
**
*******************************************************************************/
//extern
int BTM_GetConnectStatus(BD_ADDR remote_bda, int* pDiscReason);
