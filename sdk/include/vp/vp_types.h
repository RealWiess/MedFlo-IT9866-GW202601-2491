...
typedef enum _VP_MSG_TYPE
{
    ...
    #ifndef trac
    #define trac(string, ...)               do{ (void)printf(string, __VA_ARGS__); \
                                                 (void)printf("  %s [#%d]\n", __FILE__, __LINE__); \
                                            }while(false)
    #endif

    #define VP_msg(type, string, ...)      ((void)((type) ? (void)printf(string, __VA_ARGS__) : MMP_NULL))
...
#else
    #ifndef trac
    #define trac(string, args...)               do{ (void)printf(string, ## args); \
                                                    (void)printf("  %s [#%d]\n", __FILE__, __LINE__); \
                                                }while(false)
    #endif

    #define VP_msg(type, string, args...)      ((void)((type) ? (void)printf(string, ## args) : MMP_NULL))
