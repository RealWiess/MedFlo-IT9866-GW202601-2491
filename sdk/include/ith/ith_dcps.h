...
typedef struct
{
    ...
    uint8_t  DcpsMode;          ///< The flag of enabling SEAL/SPEEDY.(0 is SEAL, 1:SPEEDY)
    uint8_t  LzCpsBytePerPxl;   ///< The flag of enabling SEAL/SPEEDY.(0 is SEAL, 1:SPEEDY)
    uint8_t  IsFastBootingMode;  ///< The flag of enabling fast-booting for SPEEDY MODE.
