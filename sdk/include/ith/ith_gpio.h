...
{
    // GPIO0~GPIO3 will be switch to GPIO mode form SPI(or JTAG) by setting this
    // register
    if (pin < 4UL)
    {
 ...
 */
    #define ITH_GPIO_SET_IN(pin)                                               \
        ...
        {                                                                      \
            if ((pin) <= 31)                                                   \
            {                                                                  \
                ITH_CLEAR_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO1_PINDIR_REG,      \
                    (pin & 0x1FUL));                                           \
            }                                                                  \
            else if ((pin) >= 32 && (pin) <= 63)                               \
            {                                                                  \
                ITH_CLEAR_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO2_PINDIR_REG,      \
                    (pin & 0x1FUL));                                           \
            }                                                                  \
            else if ((pin) >= 64 && (pin) <= 95)                               \
            {                                                                  \
                ITH_CLEAR_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO3_PINDIR_REG,      \
                    (pin & 0x1FUL));                                           \
            }                                                                  \
            else if ((pin) >= 96 && (pin) <= 127)                              \
            {                                                                  \
                ITH_CLEAR_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO4_PINDIR_REG,      \
                    (pin & 0x1FUL));                                           \
            }                                                                  \
        } while (false)
 ...
 */
    #define ITH_GPIO_SET_OUT(pin)                                              \
        ...
        {                                                                      \
            if ((pin) <= 31)                                                   \
            {                                                                  \
                ITH_SET_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO1_PINDIR_REG,        \
                    (pin & 0x1FUL));                                           \
            }                                                                  \
            else if ((pin) >= 32 && (pin) <= 63)                               \
            {                                                                  \
                ITH_SET_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO2_PINDIR_REG,        \
                    (pin & 0x1FUL));                                           \
            }                                                                  \
            else if ((pin) >= 64 && (pin) <= 95)                               \
            {                                                                  \
                ITH_SET_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO3_PINDIR_REG,        \
                    (pin & 0x1FUL));                                           \
            }                                                                  \
            else if ((pin) >= 96 && (pin) <= 127)                              \
            {                                                                  \
                ITH_SET_REG_BIT_A(ITH_GPIO_BASE + ITH_GPIO4_PINDIR_REG,        \
                    (pin & 0x1FUL));                                           \
            }                                                                  \
        } while (false)
 ...
 */
    #define ITH_GPIO_SET(pin)                                                  \
        ...
        {                                                                      \
            if ((pin) <= 31)                                                   \
            {                                                                  \
                ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO1_DATASET_REG,         \
                    (0x1UL << (pin & 0x1FUL)));                                \
            }                                                                  \
            else if ((pin) >= 32 && (pin) <= 63)                               \
            {                                                                  \
                ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO2_DATASET_REG,         \
                    (0x1UL << (pin & 0x1FUL)));                                \
            }                                                                  \
            else if ((pin) >= 64 && (pin) <= 95)                               \
            {                                                                  \
                ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO3_DATASET_REG,         \
                    (0x1UL << (pin & 0x1FUL)));                                \
            }                                                                  \
            else if ((pin) >= 96 && (pin) <= 127)                              \
            {                                                                  \
                ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO4_DATASET_REG,         \
                    (0x1UL << (pin & 0x1FUL)));                                \
            }                                                                  \
        } while (false)
 ...
 */
    #define ITH_GPIO_CLEAR(pin)                                                \
        ...
        {                                                                      \
            if ((pin) <= 31)                                                   \
            {                                                                  \
                ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO1_DATACLR_REG,         \
                    (0x1UL << (pin & 0x1FUL)));                                \
            }                                                                  \
            else if ((pin) >= 32 && (pin) <= 63)                               \
            {                                                                  \
                ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO2_DATACLR_REG,         \
                    (0x1UL << (pin & 0x1FUL)));                                \                                 \
            }                                                                  \
            else if ((pin) >= 64 && (pin) <= 95)                               \
            {                                                                  \
                ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO3_DATACLR_REG,         \
                    (0x1UL << (pin & 0x1FUL)));                                \                                \
            }                                                                  \
            else if ((pin) >= 96 && (pin) <= 127)                              \
            {                                                                  \
                ITH_WRITE_REG_A(ITH_GPIO_BASE + ITH_GPIO4_DATACLR_REG,         \
                    (0x1UL << (pin & 0x1FUL)));                                \                                \
            }                                                                  \
        } while (false)
 ...
 */
    #define ITH_GPIO_GET(RESULT, pin)                                          \
        ...
        {                                                                      \
            ...
            {                                                                  \
                RESULT =                                                       \
                    ITH_READ_REG_A(ITH_GPIO_BASE + ITH_GPIO1_DATAIN_REG) &     \
                    (0x1UL << (pin & 0x1FUL));                                 \
            }                                                                  \
            else if ((pin) >= 32 && (pin) <= 63)                               \
            {                                                                  \
                RESULT =                                                       \
                    ITH_READ_REG_A(ITH_GPIO_BASE + ITH_GPIO2_DATAIN_REG) &     \
                    (0x1UL << (pin & 0x1FUL));                                 \
            }                                                                  \
            else if ((pin) >= 64 && (pin) <= 95)                               \
            {                                                                  \
                RESULT =                                                       \
                    ITH_READ_REG_A(ITH_GPIO_BASE + ITH_GPIO3_DATAIN_REG) &     \
                    (0x1UL << (pin & 0x1FUL));                                 \
            }                                                                  \
            else if ((pin) >= 96 && (pin) <= 127)                              \
            {                                                                  \
                RESULT =                                                       \
                    ITH_READ_REG_A(ITH_GPIO_BASE + ITH_GPIO4_DATAIN_REG) &     \
                    (0x1UL << (pin & 0x1FUL));                                 \
            }                                                                  \
        } while (false)
