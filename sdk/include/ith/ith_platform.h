...
#define N01_BITS_MSK     ((uint32_t)0x0001U)                       //                        1
#define N02_BITS_MSK     ((uint32_t)0x0003U)                       //                       11
#define N03_BITS_MSK     ((uint32_t)0x0007U)                       //                      111
#define N04_BITS_MSK     ((uint32_t)0x000FU)                       //                     1111
#define N05_BITS_MSK     ((uint32_t)0x001FU)                       //                   1 1111
#define N06_BITS_MSK     ((uint32_t)0x003FU)                       //                  11 1111
#define N07_BITS_MSK     ((uint32_t)0x007FU)                       //                 111 1111
#define N08_BITS_MSK     ((uint32_t)0x00FFU)                       //                1111 1111
#define N09_BITS_MSK     ((uint32_t)0x01FFU)                       //              1 1111 1111
#define N10_BITS_MSK     ((uint32_t)0x03FFU)                       //             11 1111 1111
#define N11_BITS_MSK     ((uint32_t)0x07FFU)                       //            111 1111 1111
#define N12_BITS_MSK     ((uint32_t)0x0FFFU)                       //           1111 1111 1111
#define N13_BITS_MSK     ((uint32_t)0x1FFFU)                       //         1 1111 1111 1111
#define N14_BITS_MSK     ((uint32_t)0x3FFFU)                       //        11 1111 1111 1111
#define N15_BITS_MSK     ((uint32_t)0x7FFFU)                       //       111 1111 1111 1111
#define N16_BITS_MSK     ((uint32_t)0xFFFFU)                       //      1111 1111 1111 1111
#define N17_BITS_MSK     ((uint32_t)0x1FFFFU)                      //    1 1111 1111 1111 1111
#define N18_BITS_MSK     ((uint32_t)0x3FFFFU)                      //   11 1111 1111 1111 1111
#define N19_BITS_MSK     ((uint32_t)0x7FFFFU)                      //  111 1111 1111 1111 1111
#define N20_BITS_MSK     ((uint32_t)0xFFFFFU)                      // 1111 1111 1111 1111 1111
 ...
 */
extern void ithFlushDCacheRange(void *addr, uint32_t size);
 ...
 * @param size  the memory size to flush.
 */
extern void ithInvalidateDCacheRange(void *addr, uint32_t size);
...
static inline bool ithCpuInInterrupt(void)
{
#ifndef WIN32
    #ifndef __riscv
    return ithGetCpuMode() != ITH_CPU_SYS;
    #else
    return CPU_IN_INTERRUPT();
    #endif
#else
    return false;
#endif
