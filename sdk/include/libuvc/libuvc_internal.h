...
typedef void ( * uvc_rm_cb )( void );
typedef void ( * uvc_err_hdl )( int errno );

struct uvc_device {
  struct uvc_context *ctx;
  int ref;
  struct usb_device *usb_dev;
  uvc_rm_cb  cb; //usb remove callback function
  uvc_err_hdl err_hdl; //uvc error handle callback function
};
...
//#define LIBUVC_XFER_BUF_SIZE	( 1 * 1024 * 1024 )
...
struct uvc_stream_handle {
  ...
  void *user_ptr;
  struct urb *transfers[LIBUVC_NUM_TRANSFER_BUFS];
