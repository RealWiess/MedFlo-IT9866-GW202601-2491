...
#define sys_put_be16(a,b) endian_put_be16(b, a)
#define sys_put_le16(a,b) endian_put_le16(b, a)
#define sys_put_be32(a,b) endian_put_be32(b, a)
#define sys_get_be16(a) endian_get_be16(a)
#define sys_get_le16(a) endian_get_le16(a)
#define sys_get_be32(a) endian_get_be32(a)
...
#define ITE_MESH_LOG_MODULE_0 //printf
#define ITE_MESH_LOG_MODULE_WARN //printf
...
#define BLE_MESH_LOG(lvl, ...) CAT(ITE_MESH_LOG_MODULE, CAT(_, lvl))(__VA_ARGS__)
