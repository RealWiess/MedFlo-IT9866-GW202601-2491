...
#define getAudioPluginStatus()                          ithReadRegA(AUDIO_PLUGIN_MESSAGE_REGISTER)
#define setAudioPluginStatus(value)                     ithWriteRegA(AUDIO_PLUGIN_MESSAGE_REGISTER, value)
