...
typedef int          ( * F_WRITEBYTES )( F_DRIVER * driver, void * data, unsigned long addr, int cnt  );
typedef int          ( * F_READBYTES )( F_DRIVER * driver, void * data, unsigned long addr, int cnt  );
typedef int          ( * F_ERASEBLOCK )( F_DRIVER * driver, unsigned long block );
...
typedef struct F_DRIVER
{
  ...
  F_RELEASE              release;
  F_IOCTL                ioctl;
  F_WRITEBYTES           writebytes;
  F_READBYTES            readbytes;
  F_ERASEBLOCK           eraseblock;
} _F_DRIVER;
