...
- Version: 1.1.9404, 2025/9/30
  1. Fix emulator display incorrect.
- Version: 1.1.9386, 2025/9/12
  1. *.itu export speedup.
- Version: 1.1.9300, 2025/6/18
  1. Add ArbitraryFill widget.
  2. Add OpenCV support.
- Version: 1.1.8775, 2024/1/10
  1. Add Polygon widget.
- Version: 1.1.8684, 2023/10/11
  1. Add Spinner widget.
- Version 1.1.8083, 2022/2/22
  1. Add corner mask to icon widget.
- Version 1.1.7943, 2021/9/30
  1. Add import sprite image reverse option.
  2. Add support image target set to iconlistbox for Button.
