    ...
    if (ev == ITU_EVENT_TIMER && !(dclk->digitalClockFlags & ITU_DIGITALCLOCK_STOP))
    {
        ...
        if (tm != NULL)
        {
            if (tm->tm_sec != dclk->second)
            {
                ...
                if (dclk->secondText)
                {
                    snprintf(buf, sizeof(buf), "%02i", dclk->second);
            ...
            {
                //(void)printf("[2][D_Clock] [tm_sec %d] [sec %d]\n", tm->tm_sec, dclk->second);
            }
            ...
            if (dclk->minuteText && tm->tm_min != dclk->minute)
            {
                ...
                snprintf(buf, sizeof(buf), "%02i", dclk->minute);
            ...
            if (dclk->hourText && tm->tm_hour != dclk->hour)
            {
                ...
                snprintf(buf, sizeof(buf), "%02i", hour);
            ...
            if (dclk->dayText && tm->tm_mday != dclk->day)
            {
                ...
                snprintf(buf, sizeof(buf), "%02i", dclk->day);
            ...
            if (dclk->monthText && tm->tm_mon != dclk->month)
            {
                ...
                snprintf(buf, sizeof(buf), "%02i", month);
            ...
            if (dclk->yearText && tm->tm_year != dclk->year)
            {
                ...
                snprintf(buf, sizeof(buf), "%04i", year);
...
void ituDigitalClockInit(ITUDigitalClock* dclk)
{
    ...
    (void)memset(dclk, 0, sizeof (ITUDigitalClock));
