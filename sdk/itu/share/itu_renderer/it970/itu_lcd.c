...
void ituLcdInit (void)
{
    ...
    if (!lcdSurface.m2dSurf)
    {
        ...
        lcdSurface.m2dSurf = gfxCreateSurfaceByPointer(ithLcdGetWidth(), ithLcdGetHeight(), ithLcdGetPitch(), gfxformat,
                                                       lcdSurface.surf.addr, ithLcdGetHeight() * ithLcdGetPitch());
    }
#endif
}
