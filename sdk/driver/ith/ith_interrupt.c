...
{
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_IRQ1_EN_REG, 0U);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_IRQ1_CLR_REG, 0xFFFFFFFFU);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_IRQ1_TRIGMODE_REG, 0U);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_IRQ1_TRIGLEVEL_REG, 0U);

    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_FIQ1_EN_REG, 0U);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_FIQ1_CLR_REG, 0xFFFFFFFFU);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_FIQ1_TRIGMODE_REG, 0U);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_FIQ1_TRIGLEVEL_REG, 0U);

    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_IRQ2_EN_REG, 0U);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_IRQ2_CLR_REG, 0xFFFFFFFFU);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_IRQ2_TRIGMODE_REG, 0U);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_IRQ2_TRIGLEVEL_REG, 0U);

    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_FIQ2_EN_REG, 0U);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_FIQ2_CLR_REG, 0xFFFFFFFFU);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_FIQ2_TRIGMODE_REG, 0U);
    ithWriteRegA(ITH_INTR_BASE + ITH_INTR_FIQ2_TRIGLEVEL_REG, 0U);
}
...
{
    PRINTF("Interrupt:\r\n");
    ithPrintRegA(ITH_INTR_BASE + ITH_INTR_IRQ1_SRC_REG,
                 ITH_INTR_FIQ2_SWINTR_REG - ITH_INTR_IRQ1_SRC_REG + sizeof(uint32_t));
}
