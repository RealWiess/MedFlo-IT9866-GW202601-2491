...
#if ((CFG_CHIP_FAMILY == 970) || (CFG_CHIP_FAMILY == 9860 || CFG_CHIP_FAMILY == 9830))

void ithIspEnableSharedClock (void)
{
    ithWriteRegMaskA(ITH_HOST_BASE + ITH_ISP_CLK_REG,
                     (((uint32_t)0x1U) << ITH_EN_M4CLK_BIT) | (((uint32_t)0x1U) << ITH_EN_W13CLK_BIT),
                     (((uint32_t)0x1U) << ITH_EN_M4CLK_BIT) | (((uint32_t)0x1U) << ITH_EN_W13CLK_BIT));
...
{
    ithWriteRegMaskA(ITH_HOST_BASE + ITH_ISP_CLK_REG,
                     (((uint32_t)0x0U) << ITH_EN_M4CLK_BIT) | (((uint32_t)0x0U) << ITH_EN_W13CLK_BIT),
                     (((uint32_t)0x1U) << ITH_EN_M4CLK_BIT) | (((uint32_t)0x1U) << ITH_EN_W13CLK_BIT));
...
{
    ithWriteRegMaskA(ITH_HOST_BASE + ITH_ISP_CLK_REG,
                     (((uint32_t)0x1U) << ITH_EN_DIV_ICLK_BIT) | (((uint32_t)0x1U) << ITH_EN_I0CLK_BIT) |
                         (((uint32_t)0x1U) << ITH_EN_I1CLK_BIT) | (((uint32_t)0x1U) << ITH_EN_M4CLK_BIT) |
                         (((uint32_t)0x1U) << ITH_EN_W13CLK_BIT),
                     (((uint32_t)0x1U) << ITH_EN_DIV_ICLK_BIT) | (((uint32_t)0x1U) << ITH_EN_I0CLK_BIT) |
                         (((uint32_t)0x1U) << ITH_EN_I1CLK_BIT) | (((uint32_t)0x1U) << ITH_EN_M4CLK_BIT) |
                         (((uint32_t)0x1U) << ITH_EN_W13CLK_BIT));
}
...
{
    ithWriteRegMaskA(ITH_HOST_BASE + ITH_ISP_CLK_REG,
                     (((uint32_t)0x0U) << ITH_EN_DIV_ICLK_BIT) | (((uint32_t)0x0U) << ITH_EN_I0CLK_BIT) |
                         (((uint32_t)0x0U) << ITH_EN_I1CLK_BIT) | (((uint32_t)0x0U) << ITH_EN_M4CLK_BIT) |
                         (((uint32_t)0x0U) << ITH_EN_W13CLK_BIT),
                     (((uint32_t)0x1U) << ITH_EN_DIV_ICLK_BIT) | (((uint32_t)0x1U) << ITH_EN_I0CLK_BIT) |
                         (((uint32_t)0x1U) << ITH_EN_I1CLK_BIT) | (((uint32_t)0x1U) << ITH_EN_M4CLK_BIT) |
                         (((uint32_t)0x1U) << ITH_EN_W13CLK_BIT));
}
...
void ithIspEnableTiling (ITHIspTilingMode mode, ITHIspTilingWidth width, ITHIspTilingPitch pitch)
{
    if (mode == ITH_ISP_TILING_READ)
    {
        ithWriteRegMaskA(ITH_MEM_ISP_TILING_READ_REG,
                         (pitch << ITH_ISP_TILING_READ_PITCH_BIT) | (width << ITH_ISP_TILING_READ_WIDTH_BIT) |
                             (((uint32_t)0x1U) << ITH_ISP_TILING_READ_EN_BIT),
    ...
    else if (mode == ITH_ISP_TILING_WRITE)
    {
        ithWriteRegMaskA(ITH_MEM_ISP_TILING_WRITE_REG,
                         (pitch << ITH_ISP_TILING_WRITE_PITCH_BIT) | (width << ITH_ISP_TILING_WRITE_WIDTH_BIT) |
                             (((uint32_t)0x1U) << ITH_ISP_TILING_WRITE_EN_BIT),
                         ITH_ISP_TILING_WRITE_PITCH_MASK | ITH_ISP_TILING_WRITE_WIDTH_MASK |
                             ITH_ISP_TILING_WRITE_EN_MASK);
    }
    else
    {
        /* do nothing */
...
void ithIspEnableClock (void)
{
    ithWriteRegMaskH(ITH_ISP_CLK2_REG,
                     (((uint32_t)0x1U) << ITH_EN_N5CLK_BIT) | (((uint32_t)0x1U) << ITH_EN_M5CLK_BIT) |
                         (((uint32_t)0x1U) << ITH_EN_ICLK_BIT) | (((uint32_t)0x1U) << ITH_EN_I1CLK_BIT),
                     (((uint32_t)0x1U) << ITH_EN_N5CLK_BIT) | (((uint32_t)0x1U) << ITH_EN_M5CLK_BIT) |
                         (((uint32_t)0x1U) << ITH_EN_ICLK_BIT) | (((uint32_t)0x1U) << ITH_EN_I1CLK_BIT));
...
{
    ithWriteRegMaskH(ITH_ISP_CLK2_REG,
                     (((uint32_t)0x0U) << ITH_EN_M5CLK_BIT) | (((uint32_t)0x0U) << ITH_EN_ICLK_BIT) |
                         (((uint32_t)0x0U) << ITH_EN_I1CLK_BIT),
                     (((uint32_t)0x1U) << ITH_EN_M5CLK_BIT) | (((uint32_t)0x1U) << ITH_EN_ICLK_BIT) |
                         (((uint32_t)0x1U) << ITH_EN_I1CLK_BIT));

    if ((ithReadRegH(ITH_CQ_CLK_REG) & (((uint32_t)0x1U) << ITH_EN_M3CLK_BIT)) == 0)
    {
