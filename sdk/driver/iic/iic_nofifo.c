...
// =============================================================================
#ifdef DEBUG
    #define IIC_DbgPrint        (void)printf
#else
    #define IIC_DbgPrint(x)     (void)printf(x)
#endif
...
static pthread_mutex_t  IicInternalMutex[4]  = {PTHREAD_MUTEX_INITIALIZER, PTHREAD_MUTEX_INITIALIZER, PTHREAD_MUTEX_INITIALIZER, PTHREAD_MUTEX_INITIALIZER};
    ...
    IIC_DEVICE * iic_dev)
{
    ...
    IIC_Delay_(iic_dev->delay); // liang
    ...
    uint32_t    clock)
{
    ...
    // (void)printf("IIC current clock %f KHz\n", ((double)gCurrentClock) / 1024);
    ...
    uint32_t    delay)
{
    ...
    if (IicDevices[port].refCount == 1)
    {
        ...
        if (IicDevices[port].port == IIC_PORT_0)
        {
            ...
            ithWriteRegA(ITH_GPIO_BASE + 0x238, (1 << 15) | (1UL << 31) | (IicDevices[port].ioSCLK << 16) | (IicDevices[port].ioSDA));
            //reset IIC0
        ...
        if(IicDevices[port].port == IIC_PORT_1)
        {
            ...
            ithWriteRegA(ITH_GPIO_BASE + 0x23c, (1 << 15) | (1UL << 31) | (IicDevices[port].ioSCLK << 16) | (IicDevices[port].ioSDA));
            //reset IIC1
        ...
        if(IicDevices[port].port == IIC_PORT_2)
        {
            ...
            ithWriteRegA(ITH_GPIO_BASE + 0x240, (1 << 15) | (1UL << 31) | (IicDevices[port].ioSCLK << 16) | (IicDevices[port].ioSDA));
            //reset IIC2
        ...
        if(IicDevices[port].port == IIC_PORT_3)
        {
            ...
            ithWriteRegA(ITH_GPIO_BASE + 0x244, (1 << 15) | (1UL << 31) | (IicDevices[port].ioSCLK << 16) | (IicDevices[port].ioSDA));
            //reset IIC3
        ...
        if (opMode == IIC_SLAVE_MODE)
        {
            ...
            {
                (void)printf("Create thread OK!\n");
            }
        }
    }
    else
    {
        (void)printf("ERROR! IIC multiple initialization!!!\n");
    }
    ...
    uint32_t    * data)
{
    ...
    while (ithReadRegA(IicDevices[port].regAddrBase + REG_I2C_BUS_MONITOR) != 0x3)
    {
        ...
        if (count >= 1500)
        {
            (void)printf("i2c is busy ...(Recieve)(scl=%d, sda=%d)\n", IicDevices[port].ioSCLK, IicDevices[port].ioSDA);
    ...
    uint32_t    data)
{
    ...
    while (ithReadRegA(IicDevices[port].regAddrBase + REG_I2C_BUS_MONITOR) != 0x3)
    {
        ...
        if (count >= 1500)
        {
            (void)printf("i2c is busy ...(Send)(scl=%d, sda=%d)\n", IicDevices[port].ioSCLK, IicDevices[port].ioSDA);
            IIC_Initialize(port, IIC_delay);
            break;
        }
    }
...
#endif
{
    ...
    while (ithReadRegA(IicDevices[port].regAddrBase + REG_I2C_BUS_MONITOR) != 0x3)
    {
        ...
        if (count >= 1500)
        {
            (void)printf("i2c is busy ...(SendData)(%x,%x)(scl=%d, sda=%d)\n", slaveAddr, regAddr, IicDevices[port].ioSCLK, IicDevices[port].ioSDA);
            IIC_Initialize(port, IIC_delay);
            break;
        }
    }
    ...
    uint32_t    outDataSize)
{
    ...
    while (ithReadRegA(IicDevices[port].regAddrBase + REG_I2C_BUS_MONITOR) != 0x3)
    {
        ...
        if (count >= 1500)
        {
            (void)printf("i2c is busy ...(SendDataEx)(%x)(scl=%d, sda=%d)\n", slaveAddr, IicDevices[port].ioSCLK, IicDevices[port].ioSDA);
            IIC_Initialize(port, IIC_delay);
            break;
        }
    }
    ...
    uint32_t    inDataSize)
{
    ...
    while (ithReadRegA(IicDevices[port].regAddrBase + REG_I2C_BUS_MONITOR) != 0x3)
    {
        ...
        if (count >= 1500)
        {
            printf("i2c is busy ...(ReceiveData)(%x)(scl=%d, sda=%d)\n", slaveAddr, IicDevices[port].ioSCLK, IicDevices[port].ioSDA);
            IIC_Initialize(port, IIC_delay);
            break;
        }
    }
...
#endif
{
    ...
    while (ithReadRegA(IicDevices[port].regAddrBase + REG_I2C_BUS_MONITOR) != 0x3)
    {
        ...
        if (count >= 1500)
        {
            (void)printf("i2c is busy ...(ReceiveData)(%x)(scl=%d, sda=%d)\n", slaveAddr, IicDevices[port].ioSCLK, IicDevices[port].ioSDA);
            IIC_Initialize(port, IIC_delay);
            break;
        }
    }
    ...
    uint32_t    clock)
{
    ...
    while (ithReadRegA(IicDevices[port].regAddrBase + REG_I2C_BUS_MONITOR) != 0x3)
    {
        ...
        if (count >= 1500)
        {
            (void)printf("i2c is busy ...(SetClockRate)(%x)(scl=%d, sda=%d)\n", clock, IicDevices[port].ioSCLK, IicDevices[port].ioSDA);
            IIC_Initialize(port, IIC_delay);
            break;
        }
    }
    ...
    uint32_t    outputBufferLength)
{
    ...
    {
        // (void)printf("mmpIicSlaveWrite+++++++++++ %d, 0x%x\n", port, IicDevices[port].slaveAddr);
...
mmpIicSlaveDmaWrite (
    ...
    uint32_t    outputBufferLength)
{
    (void)printf("IT9070 not support this function!!!\n");
    return 0;
}
