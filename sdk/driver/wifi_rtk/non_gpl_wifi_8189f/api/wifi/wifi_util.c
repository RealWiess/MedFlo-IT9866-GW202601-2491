...
int wext_set_pscan_channel(const char *ifname, __u8 *ch, __u8 *pscan_config, __u8 length)
{
   ...
   //printf("wext_set_pscan_channel %d %d %d, %d %d %d, length %d   \n",ch[0],ch[1],ch[2],pscan_config[0],pscan_config[1],pscan_config[2],length);
...
#if 0
    printf("wext_set_pscan_channel pointer [%s] , length %d \n",iwr.u.data.pointer,iwr.u.data.length);    
    printf("wext_set_pscan_channel pointer %d [%d %d %d] [%d %d %d]  , length %d \n",para[12],para[13],para[14],para[15],para[16],para[17],para[18],iwr.u.data.length);
