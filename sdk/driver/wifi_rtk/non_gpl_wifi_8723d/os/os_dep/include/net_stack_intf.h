...
extern unsigned char *LwIP_GetMAC(struct netif *pnetif);
extern unsigned char *LwIP_GetIP(struct netif *pnetif);
extern unsigned char *LwIP_GetGW(struct netif *pnetif);
extern unsigned char *LwIP_GetMASK(struct netif *pnetif);

#if CONFIG_WOWLAN
extern uint8_t *rltk_wlan_get_ip(int idx);
extern uint8_t *rltk_wlan_get_gw(int idx);
extern uint8_t *rltk_wlan_get_gwmask(int idx);
#endif
