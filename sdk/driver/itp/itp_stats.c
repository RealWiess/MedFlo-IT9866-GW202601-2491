    ...
    int     arg)
{
    ...
    // heap usage
    (void)printf("HEAP newlib: usage=%d/%d(%d%%),addr=%p\n",
        mi.uordblks,
        total,
    ...
    (void)printf("MEMSTAT: total=(util:%d%% BW:%dMB/s), req0=(req/total:%d%% util:%d%%), req1=(req/total:%d%% util:%d%%)\n",
