...
static bool CardIsAvail(ITPCard card)
{
    ...
    {
        ITP_LOG_DBG("cardStatusTable[%d]: card=%d inserted=%d\n", i, cardStatusTable[i].card, cardStatusTable[i].inserted );
