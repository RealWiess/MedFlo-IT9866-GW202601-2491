...
// =============================================================================
void *
TsiBufferThread (void * args);

int
TsiStopThread (uint32_t index);
int
TsiStartCache (uint32_t index);
int
TsiStopCache (uint32_t index);
