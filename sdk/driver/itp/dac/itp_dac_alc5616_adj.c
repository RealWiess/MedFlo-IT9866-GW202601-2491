...
static int32_t         _alc5616_in           = -1;
static int32_t         _alc5616_out          = -1;
static int32_t         _alc5616_slave        = 1;
...
void itp_codec_playback_set_direct_vol (uint32_t target_vol)
{
    ...
    {
        (void)printf("ERROR play# invalid target volume step: 0x%08x\n", target_vol);
        return;
    }
...
void itp_codec_rec_set_direct_vol (uint32_t target_vol)
{
    ...
    {
        (void)printf("ERROR rec# invalid target volume step: 0x%08x\n", target_vol);
        return;
    }
...
void itp_codec_set_DAC_slave_mode (int32_t mode)
{
