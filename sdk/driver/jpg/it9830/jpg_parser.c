    ...
    for (i = 0; i < compCnt; i++)
    {
        ...
        for (j = 0; j < compCnt; j++)
        {
            if (jFrmInfo[j].compId == compIdx)
            {
                ...
                switch (j)
                {
                    case 0: jFrmComp->validComp |= JPG_MSK_DEC_COMPONENT_A_VALID;
                        break;

                    case 1: jFrmComp->validComp |= JPG_MSK_DEC_COMPONENT_B_VALID;
                        break;

                    case 2: jFrmComp->validComp |= JPG_MSK_DEC_COMPONENT_C_VALID;
                        break;

                    case 3: jFrmComp->validComp |= JPG_MSK_DEC_COMPONENT_D_VALID;
                        break;
                }
            }
        }
