    ...
    ITHIntrHandler handler)
{
    ...
    ithIntrSetTriggerModeIrq(ITH_INTR_JPEG, ITH_INTR_LEVEL);
    ...
    bool                * bEncIdle)
{
    ...
    do
    {
        ...
        *bEncIdle = false;
        ...
        // complete or bs_full
        // (void)printf("before bsBufValidSize !!\n");
        // while(1);
        bsBufValidSize  = JPG_GetBitStreamValidSizeReg();
        (void)printf("bsBufValidSize=0x%x\n", bsBufValidSize);
        bsBufValidSize  *= 4;
        ...
        {
            (void)printf("run here!,bufStatus=%d\n", bufStatus);
    ...
    void                * extraData)
{
    ...
    do
    {
        ...
        while (remainSliceNum > 0)
        {
            ...
            (void)printf("(procSliceNum/pJFrmComp->jFrmInfo[0].verticalSamp)=0x%x,pJFrmComp->jFrmInfo[0].verticalSamp=0x%x,procSliceNum=0x%x\n", (procSliceNum / pJFrmComp->jFrmInfo[0].verticalSamp), pJFrmComp->jFrmInfo[0].verticalSamp, procSliceNum);
