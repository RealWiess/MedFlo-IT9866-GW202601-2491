...
typedef enum
{
    ...
    #define LOG_ERROR      ((void) ((NAND_ZONE_ERROR & NAND_LOG_ZONES) ? ((void)printf ("[NAND][ERROR]"
    #define LOG_WARNING    ((void) ((NAND_ZONE_WARNING & NAND_LOG_ZONES) ? ((void)printf ("[NAND][WARNING]"
    #define LOG_INFO       ((void) ((NAND_ZONE_INFO & NAND_LOG_ZONES) ? ((void)printf ("[NAND][INFO]"
    #define LOG_DEBUG      ((void) ((NAND_ZONE_DEBUG & NAND_LOG_ZONES) ? ((void)printf ("[NAND][DEBUG]"
    #define LOG_ENTER      ((void) ((NAND_ZONE_ENTER & NAND_LOG_ZONES) ? ((void)printf ("[NAND][ENTER]"
    #define LOG_LEAVE      ((void) ((NAND_ZONE_LEAVE & NAND_LOG_ZONES) ? ((void)printf ("[NAND][LEAVE]"
    #define LOG_DATA       ((void) ((true) ? ((void)printf (
    #define LOG_INFO2      ((void) ((true) ? ((void)printf (
    #define LOG_END        )), 1 : 0));
#endif
