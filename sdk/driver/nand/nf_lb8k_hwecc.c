    ...
    NF_CMD_TYPE type)
{
    ...
    do
    {
        ...
        if (timeOut-- == 0)
        {
            ...
            (void)printf("\tLB8K_HWECC_WaitCmdReady wait idle time out[1]!!!,0X131A=%X.\n", nfStatus);
    ...
    unsigned long   * pPageSize)
{
    ...
    if (!NF_InitDma())
    {
        (void)printf("LB8K_HWECC_Initialize: Initial DMA fail.\n");
        result = LL_ERROR;
        goto end;
    }
        #endif
...
/*
    ...
    if (result == LL_OK)
    {
        ...
        switch (eccResult)
        {
            ...
            case NF_ECCCORPASS:
                (void)printf("LB8K_HWECC_Read: pba(%u), ppo(%u), eccResult == NF_ECCCORPASS\n", pba, ppo);
                break;

            case NF_PARITYADDRERR:
                (void)printf("LB8K_HWECC_Read: ECC Correction failed. eccResult == PARITYADDRERR\n");
                result = LL_ERROR;
                break;

            case NF_OVER4ERR:
                (void)printf("LB8K_HWECC_Read: ECC Correction failed. eccResult == OVER4ERR\n");
                result = LL_ERROR;
                break;

            default:
                (void)printf("LB8K_HWECC_Read: Unknown ECC value. eccResult = %d\n", eccResult);
                result = LL_ERROR;
                break;
        }
    ...
    MMP_UINT8   * pBuffer)
{
    ...
    if (result == LL_OK)
    {
        ...
        switch (eccResult)
        {
            ...
            case NF_ECCCORPASS:
                (void)printf("LB8K_HWECC_LBA_Read: pba(%u), ppo(%u), eccResult == NF_ECCCORPASS\n", pba, ppo);
                break;

            case NF_PARITYADDRERR:
                (void)printf("LB8K_HWECC_LBA_Read: ECC Correction failed. eccResult == PARITYADDRERR\n");
                result = LL_ERROR;
                break;

            case NF_OVER4ERR:
                (void)printf("LB8K_HWECC_LBA_Read: ECC Correction failed. eccResult == OVER4ERR\n");
                result = LL_ERROR;
                break;

            default:
                (void)printf("LB8K_HWECC_LBA_Read: Unknown ECC value. eccResult = %d\n", eccResult);
                result = LL_ERROR;
                break;
        }
    ...
    MMP_UINT8   index)
{
    ...
    switch (index)
    {
        ...
        default:
            (void)printf("LB8K_HWECC_ReadPart: Unknown ECC value. eccResult = %d\n", eccResult);
            result = LL_ERROR;
            break;
    }
        #endif
    ...
    if (result == LL_OK)
    {
        ...
        switch (eccResult)
        {
            ...
            case NF_ECCCORPASS:
                (void)printf("LB8K_HWECC_ReadPart: pba(%u), ppo(%u), eccResult == NF_ECCCORPASS\n", pba, ppo);
                break;

            case NF_PARITYADDRERR:
                (void)printf("LB8K_HWECC_ReadPart: ECC Correction failed. eccResult == PARITYADDRERR\n");
                result = LL_ERROR;
                break;

            case NF_OVER4ERR:
                (void)printf("LB8K_HWECC_ReadPart: ECC Correction failed. eccResult == OVER4ERR\n");
                result = LL_ERROR;
                break;
    ...
    MMP_UINT32 pba)
{
    ...
    {
        (void)printf("\tLB8K_HWECC_IsBadBlock: ERROR! pba(%u) >= g_NfAttrib.numOfBlocks(%u)\n", pba, g_NfAttrib.numOfBlocks);
        return LL_ERROR;
    }
    ...
    // 2. Read first page
    {
        ...
        #endif
        {
            ...
            if (IfDataEqual00FF == LL_OK)
            {
                ...
                {
                    (void)printf("LB8K_HWECC_IsBadBlock: ERROR! g_NfAttrib.pfCheckMethod == MMP_NULL\n");
    ...
    MMP_UINT8   * pByte)
{
    ...
    if (result == LL_OK)
    {
        ...
        switch (eccResult)
        {
            ...
            case NF_ECCCORPASS:
                (void)printf("LB8K_HWECC_Read 1B: pba(%u), ppo(%u), eccResult == NF_ECCCORPASS\n", pba, ppo);
                break;

            case NF_PARITYADDRERR:
                (void)printf("LB8K_HWECC_Read 1B: ECC Correction failed. eccResult == PARITYADDRERR\n");
                result = LL_ERROR;
                break;

            case NF_OVER4ERR:
                (void)printf("LB8K_HWECC_Read 1B: ECC Correction failed. eccResult == OVER4ERR\n");
                result = LL_ERROR;
                break;

            default:
                (void)printf("LB8K_HWECC_Read 1B: Unknown ECC value. eccResult = %d\n", eccResult);
                result = LL_ERROR;
                break;
        }
    ...
    MMP_UINT32 * NfStatus)
{
    ...
    *NfStatus = 0;
    ...
    do
    {
        ...
        if (timeOut-- == 0)
        {
            (void)printf("\tLB8K_HWECC_WaitCmdReady wait idle time out[2]!!!\n");
            result = LL_ERROR;
            goto end;
        }
    } while ((*NfStatus & 0xc000) != NFIDLE);
