...
#define aic_dbg(fmt, args...)    do {printf(fmt, ##args);} while(0)//diag_printf(fmt, ##__VA_ARGS__)
#define printk(fmt, args...) 	 do {printf(fmt, ##args);} while(0)//diag_printf(fmt, ##__VA_ARGS__)
