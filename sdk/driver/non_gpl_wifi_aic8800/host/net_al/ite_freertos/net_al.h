...
typedef  uint32_t     TCPIP_MODEM_ID_T;           /* modem ID */
typedef  uint32_t     TCPIP_IPADDR_T;             /* integar IPv4 address */
typedef  uint16_t     TCPIP_PING_HANDLE;          /* PING request handle */
typedef  uint32_t     TCPIP_HOST_HANDLE;          /* async gethostbyname request handle */
typedef  uint32_t     TCPIP_IPCONFLICT_HANDLE;    /* IP conflict request handle */
