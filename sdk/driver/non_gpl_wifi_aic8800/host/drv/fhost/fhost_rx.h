...
__INLINE bool seqno_leq(uint16_t seq1, uint16_t seq2)
{
...
__INLINE bool seqno_lt(uint16_t seq1, uint16_t seq2)
{
    if(((seq1 < seq2) && ((seq2 - seq1) < MAX_SEQNO_BY_TWO)) ||
       ((seq1 > seq2) && ((seq1 - seq2) > MAX_SEQNO_BY_TWO)))
    {
...
__INLINE bool seqno_geq(uint16_t seq1, uint16_t seq2)
{
    return seqno_leq(seq2, seq1);
}

/* This function checks whether seq1 is greater than seq2 */
__INLINE bool seqno_gt(uint16_t seq1, uint16_t seq2)
{
