...
typedef enum _ISP_MSG_TYPE
{
    ...
    #define isp_msg(type, string, ...)                                         \
        ((void)((0U != (type & ispMsgOnFlag)) ? printf(string, __VA_ARGS__)    \
                                              : NULL))
    #define isp_msg_ex(type, string, ...)                                      \
        do                                                                     \
        {                                                                      \
            if (0U != (type & ispMsgOnFlag))                                   \
            {                                                                  \
                (void)printf(string, __VA_ARGS__);                             \
                (void)printf("  %s [#%d]\n", __FILE__, __LINE__);              \
            }                                                                  \
    ...
    #define isp_msg(type, string, args...)                                     \
        ((void)((0U != (type & ispMsgOnFlag)) ? (void)printf(string, ##args)   \
                                              : NULL))

    #define isp_msg_ex(type, string, args...)                                  \
        do                                                                     \
        {                                                                      \
            if (0U != ((type)&ispMsgOnFlag))                                   \
            {                                                                  \
...
typedef enum ISP_FLAGS_WORK_TAG
{
    ...
    ISP_FLAGS_ENABLE_BLUR             = (0x00000001 << 11)
} ISP_FLAGS_WORK;
