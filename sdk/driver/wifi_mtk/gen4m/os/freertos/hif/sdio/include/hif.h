...
struct GL_HIF_INFO {
	...
	_mutex rRxFreeBufQueMutex;
    _mutex  rRxDeAggQueMutex;
...
void glSetHifInfo(struct GLUE_INFO *prGlueInfo, void * ulCookie);
...
void glGetDev(void *ctx, /*struct device **dev*/void **dev);

void glGetHifDev(struct GL_HIF_INFO *prHif, /*struct device **dev*/void **dev);
