...
#define CFG_WLAN_LWIP_ZERO_COPY        (0)
#define CFG_WLAN_LWIP_RXZERO_COPY      (1)
/*------------------------------------------------------------------------------
 * Driver config
 *------------------------------------------------------------------------------
 */
...
#endif
#ifndef CFG_WIFI_RAM_COEX_SPDT_3ANT_CTRL
#define CFG_WIFI_RAM_COEX_SPDT_3ANT_CTRL	0
#endif
#else
#undef CFG_DBDC_SW_FOR_P2P_LISTEN
#define CFG_DBDC_SW_FOR_P2P_LISTEN	0
#undef CFG_WIFI_RAM_COEX_SPDT_3ANT_CTRL
#define CFG_WIFI_RAM_COEX_SPDT_3ANT_CTRL	0
...
#define CFG_SUPPORT_PRIV_STA_STAT 1
/*******************************************************************************
 *                             D A T A   T Y P E S
 *******************************************************************************
 */
