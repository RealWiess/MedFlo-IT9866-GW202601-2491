 ...
 */
#define FTGMAC030_MACCR_TXDMA_EN	(1U << 0)
#define FTGMAC030_MACCR_RXDMA_EN	(1U << 1)
#define FTGMAC030_MACCR_TXMAC_EN	(1U << 2)
#define FTGMAC030_MACCR_RXMAC_EN	(1U << 3)
#define FTGMAC030_MACCR_DIS_IPV6_PKTREC (1U << 7)
#define FTGMAC030_MACCR_RX_ALL		(1U << 8)
#define FTGMAC030_MACCR_HT_MULTI_EN	(1U << 9)
#define FTGMAC030_MACCR_RX_MULTIPKT	(1U << 10)
#define FTGMAC030_MACCR_RX_BROADPKT	(1U << 11)
#define FTGMAC030_MACCR_RX_RUNT		(1U << 12)
#define FTGMAC030_MACCR_JUMBO_LF	(1U << 13)
#define FTGMAC030_MACCR_ENRX_IN_HALFTX	(1U << 14)
#define FTGMAC030_MACCR_DISCARD_CRCERR	(1U << 16)
#define FTGMAC030_MACCR_CRC_APD		(1U << 17)
#define FTGMAC030_MACCR_REMOVE_VLAN	(1U << 18)
#define FTGMAC030_MACCR_PTP_EN		(1U << 20)
#define FTGMAC030_MACCR_LOOP_EN		(1U << 21)
#define FTGMAC030_MACCR_HPTXR_EN	(1U << 22)
#define FTGMAC030_MACCR_MODE_1000	(2U << 24)
#define FTGMAC030_MACCR_MODE_100	(1U << 24)
#define FTGMAC030_MACCR_SPEED_VAL(x)	((x >> 24) & 0x3)
#define FTGMAC030_MACCR_FULLDUP		(1U << 26)
#define FTGMAC030_MACCR_SW_RST		(1U << 31)
...
#define FTGMAC030_TXDES0_EDOTR		(1U << 15)
#define FTGMAC030_TXDES0_CRC_ERR	(1U << 19)
#define FTGMAC030_TXDES0_LTS		(1U << 28)
#define FTGMAC030_TXDES0_FTS		(1U << 29)
#define FTGMAC030_TXDES0_TXDMA_OWN	(1U << 31)

#define FTGMAC030_TXDES1_VLANTAG_CI(x)	((x) & 0xffff)
#define FTGMAC030_TXDES1_INS_VLANTAG	(1U << 16)
#define FTGMAC030_TXDES1_TCP_CHKSUM	(1U << 17)
#define FTGMAC030_TXDES1_UDP_CHKSUM	(1U << 18)
#define FTGMAC030_TXDES1_IP_CHKSUM	(1U << 19)
#define FTGMAC030_TXDES1_IPV6_PKT	(1U << 20)
#define FTGMAC030_TXDES1_LLC		(1U << 22)
#define FTGMAC030_TXDES1_TX2FIC		(1U << 30)
#define FTGMAC030_TXDES1_TXIC		(1U << 31)
...
#define FTGMAC030_RXDES0_EDORR		(1U << 15)
#define FTGMAC030_RXDES0_MULTICAST	(1U << 16)
#define FTGMAC030_RXDES0_BROADCAST	(1U << 17)
#define FTGMAC030_RXDES0_RX_ERR		(1U << 18)
#define FTGMAC030_RXDES0_CRC_ERR	(1U << 19)
#define FTGMAC030_RXDES0_FTL		(1U << 20)
#define FTGMAC030_RXDES0_RUNT		(1U << 21)
#define FTGMAC030_RXDES0_RX_ODD_NB	(1U << 22)
#define FTGMAC030_RXDES0_FIFO_FULL	(1U << 23)
#define FTGMAC030_RXDES0_PAUSE_OPCODE	(1U << 24)
#define FTGMAC030_RXDES0_PAUSE_FRAME	(1U << 25)
#define FTGMAC030_RXDES0_LRS		(1U << 28)
#define FTGMAC030_RXDES0_FRS		(1U << 29)
#define FTGMAC030_RXDES0_RXPKT_RDY	(1U << 31)

#define FTGMAC030_RXDES0_EOP	(FTGMAC030_RXDES0_FRS | FTGMAC030_RXDES0_LRS)

#define FTGMAC030_RXDES1_IPV6		(1U << 19)
#define FTGMAC030_RXDES1_VLANTAG_CI	0xffff
#define FTGMAC030_RXDES1_PROT_MASK	(0x3U << 20)
#define FTGMAC030_RXDES1_PROT_NONIP	(0x0U << 20)
#define FTGMAC030_RXDES1_PROT_IP	(0x1U << 20)
#define FTGMAC030_RXDES1_PROT_TCPIP	(0x2U << 20)
#define FTGMAC030_RXDES1_PROT_UDPIP	(0x3U << 20)
#define FTGMAC030_RXDES1_LLC		(1U << 22)
#define FTGMAC030_RXDES1_DF		(1U << 23)
#define FTGMAC030_RXDES1_VLANTAG_AVAIL	(1U << 24)
#define FTGMAC030_RXDES1_TCP_CHKSUM_ERR	(1U << 25)
#define FTGMAC030_RXDES1_UDP_CHKSUM_ERR	(1U << 26)
#define FTGMAC030_RXDES1_IP_CHKSUM_ERR	(1U << 27)
