    ...
    uint8_t data)
{
    ...
    *pdbuf              = (uint8_t)(data);
    ...
    {
        (void)printf("_ADV7180_WriteI2c_Byte Write Error, reg=%02x val=%02x\n", RegAddr, data);
    }
    return result;
}

uint32_t
_ADV7180_WriteI2c_ByteMask (
    uint8_t RegAddr,
    uint8_t data,
    uint8_t mask)
{
