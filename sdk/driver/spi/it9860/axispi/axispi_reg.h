...
#define SPI_REG_CMD_W0                  (REG_SPI_BASE + 0x0000U)
...
#define SPI_REG_CMD_W1					(REG_SPI_BASE + 0x0004U)
...
#define SPI_REG_CMD_W2	                (REG_SPI_BASE + 0x0008U)
...
#define SPI_REG_CMD_W3                  (REG_SPI_BASE + 0x000CU)
...
#define SPI_SHT_EN_DTR_MODE            	4U
#define SPI_SHT_OPERATE_MODE            5U
#define SPI_SHT_START_CS            	8
#define SPI_SHT_CONT_READMODE_CODE   	16
#define SPI_SHT_INST_CODE   			24U
...
#define SPI_REG_CTL              		(REG_SPI_BASE + 0x0010U)
...
#define SPI_REG_AC_TIMING               (REG_SPI_BASE + 0x0014U)
...
#define SPI_REG_STATUS                  (REG_SPI_BASE + 0x0018U)
...
#define SPI_REG_INTR_CTL                (REG_SPI_BASE + 0x0020U)

#define SPI_BIT_EN_DMA           		1
#define SPI_BIT_EN_CMD_CMPLT_INTR 	    1

#define SPI_SHT_EN_DMA           		0U
#define SPI_SHT_EN_CMD_CMPLT_INTR 	    1U
#define SPI_SHT_TXFIFO_THOD 	    	8U
#define SPI_SHT_RXFIFO_THOD 	    	12U
...
#define SPI_REG_INTR_STATUS             (REG_SPI_BASE + 0x0024U)
...
#define SPI_REG_READ_STATUS             (REG_SPI_BASE + 0x0028U)
...
#define SPI_REG_FLASH_SIZE              (REG_SPI_BASE + 0x002CU)
...
#define SPI_REG_DAMR_CMD                (REG_SPI_BASE + 0x0030U)
...
#define SPI_REG_REV		                (REG_SPI_BASE + 0x0050U)
...
#define SPI_REG_FEATURE                 (REG_SPI_BASE + 0x0054U)
...
#define SPI_REG_DATA_PORT               (REG_SPI_BASE + 0x0100U)
