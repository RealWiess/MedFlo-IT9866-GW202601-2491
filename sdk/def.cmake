...
if (DEFINED CFG_BTA_ENABLE)
    set(CFG_BUILD_BLUETOOTH_BTA y)
    add_definitions(
        -DCFG_BTA_ENABLE
    )
endif()

if (DEFINED CFG_IAP2_ENABLE)
        add_definitions(
            -DCFG_IAP2_ENABLE
        )
        set(CFG_BUILD_OPENSSL 1)
        set(CFG_BUILD_IAP2 1)
endif()
...
if ((${CMAKE_PROJECT_NAME} STREQUAL sdk_standard_ngpl)
 OR (${CMAKE_PROJECT_NAME} STREQUAL sdk_standard_ngpl_intl))
	add_definitions(-DCFG_BUILD_SDK)
endif()
...
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UCL_LIBRARY)

if (DEFINED CFG_DLM_ENABLE)
    add_definitions(
        -DCFG_UPGRADE_DLM_PACKAGE_POS=${CFG_UPGRADE_DLM_PACKAGE_POS}
    )
endif()
...
if (DEFINED CFG_SECURITY_SIGNATURE OR DEFINED CFG_NOR_USE_DPUAES)
    set(CFG_BUILD_SAFETY 1)
    set(CFG_BUILD_OTP_CHECK 1)
    set(CFG_BUILD_SECURE_BOOT 1)
endif()

if (DEFINED CFG_SECURITY_SIGNATURE)
    add_definitions(
        -DCFG_SECURITY_SIGNATURE
    )
    set(CFG_BUILD_MBEDTLS 1)
    set(CFG_BUILD_SIG_VERIFY 1)
    set(CFG_BUILD_PKG_VERIFY 1)
endif()
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_SAFETY CFG_BUILD_SAFETY)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_SIG_VERIFY CFG_BUILD_SIG_VERIFY)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_PKG_VERIFY CFG_BUILD_PKG_VERIFY)

if (DEFINED CFG_DBG_STACK_OVERFLOW)
    add_definitions(
        -DCFG_WT_SIZE=0x200000
    )
elseif ((DEFINED CFG_CPU_WB AND (DEFINED CFG_USB0_ENABLE OR DEFINED CFG_USB1_ENABLE OR DEFINED CFG_NET_ETHERNET)) OR DEFINED CFG_USBHCC)
    add_definitions(
...
if (DEFINED CFG_SECURE_DEBUG)
    add_definitions(
	    -DCFG_SECURE_DEBUG
	)
    set(CFG_BUILD_SAFETY 1)
	set(CFG_BUILD_SECURE_DEBUG 1)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_SAFETY CFG_BUILD_SAFETY)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_SECURE_DEBUG CFG_BUILD_SECURE_DEBUG)
endif()
...
if (DEFINED CFG_BUILD_MEMTESTER)
    add_definitions(
        -DCFG_BUILD_MEMTESTER
        -DCFG_MEMTESTER_SIZE=${CFG_MEMTESTER_SIZE}
    )
else()
    add_definitions(
        -DCFG_MEMTESTER_SIZE=0
    )
endif()
...
if (DEFINED CFG_M2D_ENABLE)
    ...
    if (DEFINED CFG_M2D_RESERVE_MEM_ENABLE)
        add_definitions(
            -DCFG_M2D_RESERVE_MEM_ENABLE
            -DCFG_M2D_RESERVE_MEM_SIZE=${CFG_M2D_RESERVE_MEM_SIZE}
        )
    endif()
endif()


if (DEFINED CFG_M2D_HUD_ENABLE)
    add_definitions(
        -DCFG_M2D_HUD_ENABLE
		-DCFG_BLOCK_WIDTH=${CFG_BLOCK_WIDTH}
        -DCFG_BLOCK_HEIGHT=${CFG_BLOCK_HEIGHT}
		-DCFG_HUD_SRC_FILENAME="${CFG_HUD_SRC_FILENAME}"
		-DCFG_HUD_DST_FILENAME="${CFG_HUD_DST_FILENAME}"
    )

	if (DEFINED CFG_HUD_AUTO_GENERATE)
    add_definitions(
        -DCFG_HUD_AUTO_GENERATE
    )
	endif()

    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_HUD_ROTATE_0)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_HUD_ROTATE_90)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_HUD_ROTATE_180)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_HUD_ROTATE_270)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_HUD_ROTATE_MIRROR)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_HUD_ROTATE_FLIP)


    if (DEFINED CFG_HUD_ROTATE_0)
        ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_HUD_ROTATE_TYPE 0)
    elseif (DEFINED CFG_HUD_ROTATE_90)
        ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_HUD_ROTATE_TYPE 1)
    elseif (DEFINED CFG_HUD_ROTATE_180)
        ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_HUD_ROTATE_TYPE 2)
    elseif (DEFINED CFG_HUD_ROTATE_270)
        ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_HUD_ROTATE_TYPE 3)
    elseif (DEFINED CFG_HUD_ROTATE_MIRROR)
        ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_HUD_ROTATE_TYPE 4)
    elseif (DEFINED CFG_HUD_ROTATE_FLIP)
        ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_HUD_ROTATE_TYPE 5)
    endif()
...
if (DEFINED CFG_JPEG_HW_ENABLE)
    ...
    if(NOT DEFINED CFG_CAPTURE_ONFLY_MODE_ENABLE)
    add_definitions(
        -DCFG_JPG_INTERACTIVE_ENABLE
    )
    endif()

    set(CFG_BUILD_ISP 1)
    set(CFG_BUILD_JPG 1)
    set(CFG_BUILD_JPEGSCALE 1)
    set(CFG_BUILD_ASYNC_FILE 1)

    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_JPEG_FAST_ENCODE_ENABLE)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_JPEG_DMA_ENABLE)
...
if (DEFINED CFG_ITV_VP_DUAL_WINDOWS)
    add_definitions(
        -DCFG_ITV_VP_DUAL_WINDOWS
    )
endif()
...
if (DEFINED CFG_AUDIO_ENABLE)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_AUDIO_CODEC_VORBISDEC)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_AUDIO_CODEC_OPUSDEC)
	...
	#ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_NS)
	#ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_TVS)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USE_CYBERON_ASR_LIB_MODULE)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USE_WANSON_ASR_LIB_MODULE)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_CHINESE_ASR_SYS)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_ENGLISH_ASR_SYS)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_FLOWER)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_MP3DEC)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_AACDEC)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_VORBISDEC)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_OPUS)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_FFMPEG_AUDIO_DECODE)

    set(CFG_BUILD_AUDIO 1)
    set(CFG_BUILD_RISC 1)

	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_AV_MIX_FILTER)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_RESERVE_FILTER)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MIXENABLE)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_FADE_FILTER)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_CHANNEL_SELECT)
...
if (DEFINED CFG_ARMLITE_ENABLE)
    ...
    add_definitions(
        -DCFG_RISC_ENABLE
        -DCFG_ARMLITE_ENABLE
        -DCFG_HW_TIMER=${CFG_HW_TIMER}
    )

    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_ARMLITE_OPUS_CODEC)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_ARMLITE_HUD_BG_FAST)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_ARMLITE_CANBUS)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_ARMLITE_LCD_CRC_CAL)
endif()
...
if (DEFINED CFG_VIDEO_ENABLE)
    ...
    if (DEFINED CFG_FAST_DISPLAY_ENABLE)
        add_definitions(
            -DFAST_DISPLAY_ENABLE
        )
    endif()
    set(CFG_BUILD_ISP 1)

    if(DEFINED CFG_CAPTURE_ONFLY_MODE_ENABLE)
    add_definitions(
        -DCFG_CAPTURE_ONFLY_MODE_ENABLE
    )
    else()
    add_definitions(
        -DCFG_JPG_INTERACTIVE_ENABLE
...
if(DEFINED CFG_CANBUS_ENABLE)
	...
	if(DEFINED CFG_CANBUS_FD_ENABLE)
    add_definitions(
        -DCFG_CANBUS_FD_ENABLE
    )
	endif()
endif()

#can transceiver
if(DEFINED CFG_CANBUS_XCVR_ENABLE)
    set(CFG_BUILD_CAN_TRANSCEIVER 1)
	add_definitions(
        -DCFG_CANBUS_XCVR_ENABLE
    )
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_ATA6570)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_TJA1145A)
endif()


#can hal
if(DEFINED CFG_CANBUS_HAL_ENABLE)
    set(CFG_BUILD_CAN_HAL 1)
	add_definitions(
        -DCFG_CANBUS_HAL_ENABLE
    )
endif()

#UDS
if(DEFINED CFG_UDS_ENABLE OR DEFINED CFG_UPGRADE_FROM_CAN)
    set(CFG_BUILD_UDS_SERVER 1)
	set(CFG_BUILD_UDS_INTERFACE 1)
endif()
...
if (DEFINED CFG_SD0_ENABLE)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SD0_SW_SCLK_GATING)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SDIO0_STATIC)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SD0_CARD_1BIT)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SD0_CARD_EMMC)
    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_SD0_HOST_CACHE_SIZE)
    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_SD0_HOST_CACHE_PAGE_SIZE)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC0_BKOPS_ENABLE)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC0_BKOPS_MANUAL)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC0_BKOPS_AUTO)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC0_INIT_FORCE_DO_BKOPS)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC0_CACHE_ENABLE)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC0_POWER_OFF_NOTIFY_ENABLE)
    set(CFG_BUILD_SD 1)
...
if (DEFINED CFG_SD1_ENABLE)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SD1_NO_PIN_SHARE)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SD1_SW_SCLK_GATING)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SDIO1_STATIC)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SD1_CARD_1BIT)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SD1_CARD_EMMC)
    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_SD1_HOST_CACHE_SIZE)
    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_SD1_HOST_CACHE_PAGE_SIZE)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC1_BKOPS_ENABLE)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC1_BKOPS_MANUAL)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC1_BKOPS_AUTO)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC1_INIT_FORCE_DO_BKOPS)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC1_CACHE_ENABLE)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EMMC1_POWER_OFF_NOTIFY_ENABLE)
    set(CFG_BUILD_SD 1)
    #set(CFG_BUILD_LINUX 1)
endif()
...
if (DEFINED CFG_NAND_ENABLE)
    add_definitions(
        ...
        -DCFG_NAND_READ_CACHE_SIZE=${CFG_NAND_READ_CACHE_SIZE}
    )
    ...
    if (DEFINED CFG_SPI_NAND)
        ...
        if (DEFINED CFG_AXISPI_ENABLE)
            ...
            ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NAND_CHIP_SEL_ID)    
        endif()
        set(CFG_BUILD_SPI 1)

		ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_ALLOW_CHANGE_RESERVED_SIZE)
...
if (DEFINED CFG_NOR_ENABLE)
    ...
    if (DEFINED CFG_NOR_USE_DPUAES)
        ...
        if (DEFINED CFG_NOR_DPUAES_APP_KEY)
            add_definitions(
                -DCFG_NOR_DPUAES_APP_KEY=${CFG_NOR_DPUAES_APP_KEY}
            )
        endif()
        ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_FW_DPUAES_UPGRADE_MARK_POS)
    endif()
    ...
    if (DEFINED CFG_NOR_USE_AXISPI)
        ...
        set(CFG_BUILD_AXISPI 1)
        ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_CHIP_SEL_ID)    
    endif()

    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NOR_ENABLE_QUADMODE)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NOR_ENABLE_DTRMODE)

    if (DEFINED CFG_NOR_DTRMODE_FREQ)
        add_definitions(
            -DCFG_NOR_DTRMODE_FREQ=${CFG_NOR_DTRMODE_FREQ}
        )
    endif()
    ...
    elseif (DEFINED CFG_SPI_NAND AND NOT DEFINED CFG_SPI_NAND_USE_AXISPI)
        add_definitions(
...
if (DEFINED CFG_A_B_DUAL_BOOT_ENABLE)
	add_definitions(
        -DCFG_A_B_DUAL_BOOT_ENABLE
    )
    if (DEFINED CFG_DYNAMIC_MOUNT_FS_ENABLE)
		add_definitions(
        	-DCFG_DYNAMIC_MOUNT_FS_ENABLE
    	)
	endif()
endif()
...
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_FILEX)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BUILD_LEVELX)

ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_PARTITION0_READONLY)
ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_PARTITION1_READONLY)
ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_PARTITION2_READONLY)
ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_PARTITION3_READONLY)
ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_PARTITION4_READONLY)
ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_PARTITION5_READONLY)

if (DEFINED CFG_FS_LFS)
    if (DEFINED CFG_NAND_ENABLE)
        if (NOT DEFINED CFG_LFS_HAVE_HCCFTL)
            math(EXPR CFG_LFS_NAND_PTADDRESS "${CFG_NAND_RESERVED_SIZE}-256")
            message(STATUS "CFG_LFS_NAND_PTADDRESS=${CFG_LFS_NAND_PTADDRESS}")
            add_definitions(-DCFG_LFS_NAND_PTADDRESS=${CFG_LFS_NAND_PTADDRESS})
        endif()
    else()
        if (DEFINED CFG_SD0_PARTITION0)
            if (DEFINED CFG_UPGRADE_LFS_FAT_ON_PARTITION0)
                if (DEFINED CFG_UPGRADE_BACKUP_RAW_DATA)
                    set(CFG_LFS_FAT_GAP "327680")
                else()
                    set(CFG_LFS_FAT_GAP "327680")
                endif()
                math(EXPR CFG_LFS_SD0_PTADDRESS "${CFG_SD0_RESERVED_SIZE}+${CFG_SD0_PARTITION0_SIZE}+${CFG_LFS_FAT_GAP}-256")
            elseif (DEFINED CFG_UPGRADE_LFS_FAT_ON_PARTITION0_AND_1)
                ...
                math(EXPR CFG_LFS_SD0_PTADDRESS "${CFG_SD0_RESERVED_SIZE}+${CFG_SD0_PARTITION0_SIZE}+${CFG_SD0_PARTITION1_SIZE}+${CFG_LFS_FAT_GAP}-256")
            else()
                math(EXPR CFG_LFS_SD0_PTADDRESS "${CFG_SD0_RESERVED_SIZE}-256")
            endif()
            message(STATUS "CFG_LFS_SD0_PTADDRESS=${CFG_LFS_SD0_PTADDRESS}")
            add_definitions(-DCFG_LFS_SD0_PTADDRESS=${CFG_LFS_SD0_PTADDRESS})
        endif()
        if (DEFINED CFG_SD1_PARTITION0)
            if (DEFINED CFG_UPGRADE_LFS_FAT_ON_PARTITION0)
                ...
                math(EXPR CFG_LFS_SD1_PTADDRESS "${CFG_SD1_RESERVED_SIZE}+${CFG_SD1_PARTITION0_SIZE}+${CFG_LFS_FAT_GAP}-256")
            elseif (DEFINED CFG_UPGRADE_LFS_FAT_ON_PARTITION0_AND_1)
                if (DEFINED CFG_UPGRADE_BACKUP_RAW_DATA)
                    set(CFG_LFS_FAT_GAP "327680")
                else()
                ...
                math(EXPR CFG_LFS_SD1_PTADDRESS "${CFG_SD1_RESERVED_SIZE}+${CFG_SD1_PARTITION0_SIZE}+${CFG_SD1_PARTITION1_SIZE}+${CFG_LFS_FAT_GAP}-256")
            else()
                math(EXPR CFG_LFS_SD1_PTADDRESS "${CFG_SD1_RESERVED_SIZE}-256")
            endif()
            message(STATUS "CFG_LFS_SD1_PTADDRESS=${CFG_LFS_SD1_PTADDRESS}")
            add_definitions(-DCFG_LFS_SD1_PTADDRESS=${CFG_LFS_SD1_PTADDRESS})
        endif()
        if(DEFINED CFG_NOR_PARTITION0)
            if (DEFINED CFG_UPGRADE_LFS_FAT_ON_PARTITION0)
                ...
                math(EXPR CFG_LFS_NOR_PTADDRESS "${CFG_NOR_RESERVED_SIZE}+${CFG_NOR_PARTITION0_SIZE}+${CFG_LFS_FAT_GAP}-256")
            elseif (DEFINED CFG_UPGRADE_LFS_FAT_ON_PARTITION0_AND_1)
                if (DEFINED CFG_UPGRADE_BACKUP_RAW_DATA)
                    set(CFG_LFS_FAT_GAP "327680")
                else()
                ...
                math(EXPR CFG_LFS_NOR_PTADDRESS "${CFG_NOR_RESERVED_SIZE}+${CFG_NOR_PARTITION0_SIZE}+${CFG_NOR_PARTITION1_SIZE}+${CFG_LFS_FAT_GAP}-256")
            else()                
                math(EXPR CFG_LFS_NOR_PTADDRESS "${CFG_NOR_RESERVED_SIZE}-256")
            endif()
            message(STATUS "CFG_LFS_NOR_PTADDRESS=${CFG_LFS_NOR_PTADDRESS}")
            add_definitions(-DCFG_LFS_NOR_PTADDRESS=${CFG_LFS_NOR_PTADDRESS})
        endif()
    endif()    
    add_definitions(
        -DCFG_FS_LFS=1
        -DCFG_HAVE_LFS=1
        -DLFS_THREADSAFE=1
        -DCFG_LFS_CACHE_SIZE=${CFG_LFS_CACHE_SIZE}
        )
    if (DEFINED CFG_LFS_HAVE_HCCFTL)
        add_definitions(
            -DCFG_LFS_HAVE_HCCFTL=1
        )
    endif()
...
if (DEFINED CFG_FS_YAFFS2)
    ...
    if (DEFINED CFG_YAFFS2_LOG)
        add_definitions(
            -DCFG_YAFFS2_LOG
        )
    endif()
    set(CFG_BUILD_YAFFS2   1)
    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_YAFFS2_WRITE_CHECK_LEVEL)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_YAFFS2_LAZY_GC)
endif()

ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NAND_PARTITION0)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NOR_PARTITION0)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SD0_PARTITION0)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SD1_PARTITION0)
...
if (DEFINED CFG_A_B_DUAL_BOOT_ENABLE AND NOT DEFINED CFG_DYNAMIC_MOUNT_FS_ENABLE)
	add_definitions(
    	-DCFG_SUB_PRIVATE_DRIVE="${CFG_SUB_PRIVATE_DRIVE}"
    	-DCFG_SUB_PUBLIC_DRIVE="${CFG_SUB_PUBLIC_DRIVE}"
	)
endif()
...
# eFuse
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_EFUSE_ENABLE)
...
if(DEFINED CFG_RTC_ENABLE)
    ...
    if(DEFINED CFG_RTC_CALIBRATE_ENABLE)
        add_definitions(
            -DCFG_RTC_CALIBRATE_ENABLE
            -DCFG_RTC_CALIBRATE_TIMER=${CFG_RTC_CALIBRATE_TIMER}
        )
    endif()
endif()
...
# PSQ9905 disable flag just for temporary use
if (DEFINED CFG_PMIC_PSQ9905_WD)
    add_definitions(
        -DCFG_PMIC_PSQ9905_WD
    )
endif()
...
if (DEFINED CFG_SPI0_ENABLE)
    add_definitions(
        -DCFG_SPI0_ENABLE
        -DCFG_SPI0_DO_GPIO=${CFG_SPI0_DO_GPIO}
        -DCFG_SPI0_DI_GPIO=${CFG_SPI0_DI_GPIO}
...
if (DEFINED CFG_SPI1_ENABLE)
    add_definitions(
        -DCFG_SPI1_ENABLE
        -DCFG_SPI1_DO_GPIO=${CFG_SPI1_DO_GPIO}
        -DCFG_SPI1_DI_GPIO=${CFG_SPI1_DI_GPIO}
...
if (DEFINED CFG_I2S_ENABLE)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED_BOOL(CFG_I2S_HDMI_RX_CLK)
    ITE_ADD_DEFINITIONS_IF_DEFINED_BOOL(CFG_I2S_PLL_FIXED)
	ITE_ADD_DEFINITIONS_IF_DEFINED_BOOL(CFG_I2S_FOR_BT)
...
function(ITE_ADD_DEFINITIONS_IF_DEFINED_CFG_UARTN_ENABLE n)
    if (DEFINED CFG_UART${n}_ENABLE)
        add_definitions(
			...
			-DCFG_UART${n}_PARITY=${CFG_UART${n}_PARITY}
        )
...
if ($ENV{CFG_PLATFORM} STREQUAL openrtos)
    if (DEFINED CFG_BUILD_BLUETOOTH)
		...
		elseif (DEFINED CFG_BUILD_BLUEWARE)
			set(CFG_BUILD_BLUEWARE y)
            add_definitions(
                -DCFG_BUILD_BLUEWARE
            )
		endif()
...
if ($ENV{CFG_PLATFORM} STREQUAL openrtos)
    if (DEFINED CFG_USBHCC)
        ...
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USBH_CD_CCID)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USBH_CD_HID)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USBH_CD_MOUSE_ITU)
        ...
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USBH_CD_BULK_RAW)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USBH_CD_UVC)
        ...
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USBD_CD_CDCNCM)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USBD_CD_CDCECM)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_DBG_USBHCC)
        ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_DBG_USBHCC_BUFSIZE)
        ...
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USBD_CD_BULK_RAW)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USBD_CD_CDCACM_RAW)
        ...
        if (DEFINED CFG_USBD_CD_CDCACM_RAW)
            add_definitions(
                -DHAVE_USBD_CD_BULK_RAW
                -DHAVE_USBD_CD_CDCACM
                -DCFG_USBD_COMPOSITE
            )
        endif()
    endif()
...
if ($ENV{CFG_PLATFORM} STREQUAL openrtos)
    ...
    if (DEFINED CFG_UVC_ENABLE)
        ...
        if (NOT DEFINED CFG_USBH_CD_UVC)
            set(CFG_BUILD_UVC 1)
        endif()
    endif()
...
if (DEFINED CFG_KEYPAD_ENABLE)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_KEYPAD_MULTIPLE)
endif()
...
#    )
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_TOUCH_USB)
...
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MEM_BIST_ENABLE)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_DMA_TEST_ENABLE)
...
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_CAPTURE_ENABLE)
...
if (DEFINED CFG_ALT_CPU_ENABLE)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_FREQ_DETECT)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_WATCHDOG_MONITOR)
    ...
    if (DEFINED CFG_SW_UART_LIN)
        add_definitions(
            -DCFG_SW_UART_LIN
            -DCFG_SW_UART_LIN_BAUDRATE=${CFG_SW_UART_LIN_BAUDRATE}
            -DCFG_GPIO_SW_UART_LIN_TX=${CFG_GPIO_SW_UART_LIN_TX}
            -DCFG_GPIO_SW_UART_LIN_RX=${CFG_GPIO_SW_UART_LIN_RX}
        )
    endif()
...
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_GPIO_SD_WIFI_POWER_ENABLE)
if (DEFINED CFG_GPIO_SD_WIFI_POWER_ENABLE)
    add_definitions(
        -DCFG_GPIO_SD_WIFI_POWER_PIN=${CFG_GPIO_SD_WIFI_POWER_PIN}
        -DCFG_GPIO_SD_WIFI_WAKEUP_PIN=${CFG_GPIO_SD_WIFI_WAKEUP_PIN}
        -DCFG_GPIO_SD_WIFI_WL_REG_PIN=${CFG_GPIO_SD_WIFI_WL_REG_PIN}
    )
endif()
...
if (DEFINED CFG_PMIC_WD_ENABLE)
    add_definitions(
        -DCFG_PMIC_WD_ENABLE
        -DCFG_PMIC_WATCHDOG_TIMEOUT=${CFG_PMIC_WATCHDOG_TIMEOUT}
        -DCFG_PMIC_WATCHDOG_REFRESH_INTERVAL=${CFG_PMIC_WATCHDOG_REFRESH_INTERVAL}
    )
    
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_PMIC_WATCHDOG_IDLETASK)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_PMIC_I2C0)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_PMIC_I2C1)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_PMIC_I2C2)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_PMIC_I2C3)
endif()
...
ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_GPIO_I2S_USER)
...
# Network
#==== LWIP Memory Option ====
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_LWIP_OPT_MEM_DFU)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_LWIP_OPT_MEM_LOW)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_LWIP_OPT_MEM_HIGH)

#==== LWIP Internet Protocol ====
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_LWIP_IPV4)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_LWIP_IPV6)

#==== LWIP VLAN ====
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_ETH_SW_VLAN)

#==== LWIP Compatible Sockets(BSD) ====
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_LWIP_COMPAT)

#==== LWIP Address Conflict Detection ====
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_LWIP_IPV4_ACD)

#==== Multi-MAC ====
if (DEFINED CFG_NET_PRIO_MULTI_MAC)
    add_definitions(
        -DCFG_NET_PRIO_MULTI_MAC=${CFG_NET_PRIO_MULTI_MAC}
    )
endif()
...
if (DEFINED CFG_NET_ENABLE)
    ...
    elseif (DEFINED CFG_NET_LWIP_2)
        ...
        if (DEFINED CFG_NET_ETH_SW_VLAN)
            ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_ETHARP_VLAN_CHECK)
        endif()
    endif()
    ...
    if (DEFINED CFG_NET_ETHERNET)
        ...
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_ETH_HW_VLAN)
        ...
        if ($ENV{CFG_PLATFORM} STREQUAL openrtos)
            ...
            ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_RTL8201_COMPATIBLE)
            ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_LAN8720)
            ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_TJA1101)
    ...
    if (DEFINED CFG_NET_WIFI)
        ...
        #==== MTK WIFI Drivers ====
        ITE_ADD_DEFINITIONS_IF_DEFINED_CFG_NET_WIFI_(SDIO_NGPL_MT7921 NON_GPL_WIFI_MT7921)

        if (DEFINED CFG_NET_WIFI_SDIO_NGPL_MT7921)
            set(CFG_BUILD_WIFI_MTK 1)
            ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_VND_MTK)
        endif()

        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MT7921BLE)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MT7921S_USE_UART0_CLI)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MT7921S_ENABLE_BOOTS)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MT7921S_ENABLE_PICUS)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MT7921S_ENABLE_HCI)

        #==== RTK WIFI Drivers ====
        ITE_ADD_DEFINITIONS_IF_DEFINED_CFG_NET_WIFI_(SDIO_NGPL_8189FTV NON_GPL_WIFI_8189F)
        ITE_ADD_DEFINITIONS_IF_DEFINED_CFG_NET_WIFI_(SDIO_NGPL_8723DS NON_GPL_WIFI_8723D)
        ITE_ADD_DEFINITIONS_IF_DEFINED_CFG_NET_WIFI_(SDIO_NGPL_8821CS NON_GPL_WIFI_8821C)
        ITE_ADD_DEFINITIONS_IF_DEFINED_CFG_NET_WIFI_(SDIO_NGPL_8733BS NON_GPL_WIFI_8733B)

		if (DEFINED CFG_NET_WIFI_SDIO_NGPL_8189FTV OR
			DEFINED CFG_NET_WIFI_SDIO_NGPL_8723DS OR
			DEFINED CFG_NET_WIFI_SDIO_NGPL_8821CS OR
            DEFINED CFG_NET_WIFI_SDIO_NGPL_8733BS)
            set(CFG_BUILD_WIFI_RTK 1)
            ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_VND_RTK)
		endif()
        ...
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_NGPL_SYN4345x)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_NGPL_SYN4343x)
		ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_MHD_P2P)
        ...
        if (DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6256 OR
            ...
            DEFINED CFG_NET_WIFI_SDIO_NGPL_AP6203 OR
            DEFINED CFG_NET_WIFI_SDIO_NGPL_SYN4345x OR
            DEFINED CFG_NET_WIFI_SDIO_NGPL_SYN4343x)
            set(CFG_BUILD_NON_GPL_WIFI_MHD 1)
            ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_VND_MHD)
        endif()
        #==========================

        #==== ATBM WIFI Driver ====
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_NGPL_ATBM6031)

        if (DEFINED CFG_NET_WIFI_SDIO_NGPL_ATBM6031)
            set(CFG_BUILD_NON_GPL_WIFI_ATBM 1)
        endif()
        #==========================

		#==== AIC WIFI Driver ====
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_NGPL_AIC8800)
        if (DEFINED CFG_NET_WIFI_SDIO_NGPL_AIC8800)
            set(CFG_BUILD_NON_GPL_WIFI_AIC8800 1)
			ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_VND_AIC)
			add_definitions(
                    -DCFG_NET_WIFI_AIC8800
            )
        endif()
        #==========================

        #====== Applications ======
        if (DEFINED CFG_NET_WIFI_SDIO_VND_MTK OR
            DEFINED CFG_NET_WIFI_SDIO_VND_RTK OR
            DEFINED CFG_NET_WIFI_SDIO_VND_MHD OR
            DEFINED CFG_NET_WIFI_SDIO_NGPL_ATBM6031 OR
            DEFINED CFG_NET_WIFI_SDIO_VND_AIC)
        ...
        #===== Related options ====
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_ETH_EX)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_ECM_EX)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_MP_MODE)
        ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_WIFI_SDIO_POWER_ON_OFF_USER_DEFINED)

        if (DEFINED CFG_NET_WIFI_MP_MODE)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_A7670C_4G)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_EC600U_4G)
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_NET_N58_4G)
    ...
    if (DEFINED CFG_AIR_PLAY)
        add_definitions(
            -DCFG_AIR_PLAY
        )
        set(CFG_BUILD_AIR_PLAY 1)
    endif()

	if (DEFINED CFG_AUTOMOTIVE_DISPLAY)
        add_definitions(
            -DCFG_AUTOMOTIVE_DISPLAY
        )
    endif()
...
if (DEFINED CFG_DBG_STATS)
    ...
    ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_DBG_STATS_TCPIP_SNMP)
...
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_DBG_STACK_OVERFLOW)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_DBG_STACK_PROTECTOR)

# Upgrade
if(DEFINED CFG_SKIP_UPGRADE_CHECK_BOOT_TIME)
    add_definitions(
        -DCFG_SKIP_UPGRADE_CHECK_BOOT_TIME
    )
endif()
...
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_BOOTLOADER_NAND)

if (DEFINED CFG_UPGRADE_IMAGE_POS)
    add_definitions(
        -DCFG_UPGRADE_IMAGE_POS=${CFG_UPGRADE_IMAGE_POS}
    )
else()
    add_definitions(
        -DCFG_UPGRADE_IMAGE_POS=0
    )
endif()

if (DEFINED CFG_A_B_DUAL_BOOT_ENABLE)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_SUB_IMAGE_NAND)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_SUB_IMAGE_NOR)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_SUB_IMAGE_SD0)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_SUB_IMAGE_SD1)
	if (DEFINED CFG_UPGRADE_SUB_IMAGE_POS)
    	add_definitions(
        	-DCFG_UPGRADE_SUB_IMAGE_POS=${CFG_UPGRADE_SUB_IMAGE_POS}
    	)
	else()
    	add_definitions(
        	-DCFG_UPGRADE_SUB_IMAGE_POS=0
    	)
	endif()
endif()
...
if (DEFINED CFG_UPGRADE_BACKUP_RAW_DATA)
    add_definitions(
        -DCFG_UPGRADE_BACKUP_RAW_DATA
        -DCFG_UPGRADE_BACKUP_RAW_DATA_FW_POS=${CFG_UPGRADE_BACKUP_RAW_DATA_FW_POS}
        -DCFG_UPGRADE_BACKUP_RAW_DATA_FW_SIZE=${CFG_UPGRADE_BACKUP_RAW_DATA_FW_SIZE}
        -DCFG_UPGRADE_BACKUP_RAW_DATA_PARTITION0_POS=${CFG_UPGRADE_BACKUP_RAW_DATA_PARTITION0_POS}
        -DCFG_UPGRADE_BACKUP_RAW_DATA_PARTITION0_SIZE=${CFG_UPGRADE_BACKUP_RAW_DATA_PARTITION0_SIZE}
        -DCFG_UPGRADE_BACKUP_RAW_DATA_PARTITION1_POS=${CFG_UPGRADE_BACKUP_RAW_DATA_PARTITION1_POS}
        -DCFG_UPGRADE_BACKUP_RAW_DATA_PARTITION1_SIZE=${CFG_UPGRADE_BACKUP_RAW_DATA_PARTITION1_SIZE}
        -DCFG_UPGRADE_BACKUP_RAW_DATA_PARTITION2_POS=${CFG_UPGRADE_BACKUP_RAW_DATA_PARTITION2_POS}
        -DCFG_UPGRADE_BACKUP_RAW_DATA_PARTITION2_SIZE=${CFG_UPGRADE_BACKUP_RAW_DATA_PARTITION2_SIZE}
        -DCFG_UPGRADE_BACKUP_RAW_DATA_PARTITION3_POS=${CFG_UPGRADE_BACKUP_RAW_DATA_PARTITION3_POS}
        -DCFG_UPGRADE_BACKUP_RAW_DATA_PARTITION3_SIZE=${CFG_UPGRADE_BACKUP_RAW_DATA_PARTITION3_SIZE}
    )
endif()

ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_BACKUP_RAW_DATA_NAND)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_BACKUP_RAW_DATA_NOR)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_BACKUP_RAW_DATA_SD0)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_BACKUP_RAW_DATA_SD1)

if (DEFINED CFG_A_B_DUAL_BOOT_ENABLE)
	if (DEFINED CFG_BOOT_ARGS_POS)
    	add_definitions(
        	-DCFG_BOOT_ARGS_STORAGE
        	-DCFG_BOOT_ARGS_POS=${CFG_BOOT_ARGS_POS}
    	)

    	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BOOT_ARGS_NAND)
    	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BOOT_ARGS_NOR)
    	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BOOT_ARGS_SD0)
    	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_BOOT_ARGS_SD1)
	endif()

	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MAIN_DATA_NAND)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MAIN_DATA_NOR)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MAIN_DATA_SD0)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_MAIN_DATA_SD1)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SUB_DATA_NONE)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SUB_DATA_NAND)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SUB_DATA_NOR)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SUB_DATA_SD0)
	ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_SUB_DATA_SD1)
	ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_PRIVATE_PARTITION)
	ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_PUBLIC_PARTITION)
	ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_SUB_PRIVATE_PARTITION)
	ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_SUB_PUBLIC_PARTITION)
endif()

if (DEFINED CFG_UPGRADE_BACKUP_FAT_MBR)
    add_definitions(
        -DCFG_UPGRADE_BACKUP_FAT_MBR
    )
endif()
...
#canbus upgrade
ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_UPGRADE_FROM_CAN)

if (DEFINED CFG_UPGRADE_LFS_FAT_ON_PARTITION0)
    add_definitions(
        -DCFG_UPGRADE_LFS_FAT_ON_PARTITION0
        -DCFG_UPGRADE_PARTITION
    )

    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_PARTITION0_SIZE)
    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_PARTITION1_SIZE)
    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_PARTITION2_SIZE)
    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_NOR_PARTITION3_SIZE)
    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_UPGRADE_NOR_IMAGE_SIZE)
    ITE_ADD_DEFINITIONS_IF_DEFINED_VALUE(CFG_LFS_FAT_GAP)
endif()

if (DEFINED CFG_UPGRADE_LFS_FAT_ON_PARTITION0_AND_1)
    add_definitions(
        -DCFG_UPGRADE_LFS_FAT_ON_PARTITION0_AND_1
        -DCFG_UPGRADE_PARTITION
    )
...
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_LFS_ON_SD)
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_UPGRADE_FAT_ON_SD)
...
ITE_ADD_DEFINITIONS_IF_DEFINED(CFG_USBD_ECM)
...
if ($ENV{CFG_PLATFORM} STREQUAL win32)
    ...
    if (DEFINED CFG_ENABLE_COVERAGE)
        set(CFG_BUILD_GCOV y)
    endif()
endif()

# Difference Upgrade
if(IS_DIRECTORY "${CMAKE_BINARY_DIR}/data")
    # reset build/<project>/data
