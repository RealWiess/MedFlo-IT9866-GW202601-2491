...
# ITE@ichunlai
#
# The code below is from https://github.com/eclipse-cyclonedds/cyclonedds/blob/master/cmake/Modules/FindSphinx.cmake
# (20210519 commit id: 84891c9)
#
# The original version has many bugs. I have fixed some problems to make it work on
# win32 environment. You can compare the modified version and the original version to
# see what are difference. DON'T USE THE ORIGION VERSION DIRECTLY.
#
...
macro(_Sphinx_find_executable _exe)
    ...
    if (${SPHINX_${_uc}_EXECUTABLE} STREQUAL "SPHINX_${_uc}_EXECUTABLE-NOTFOUND")
        set(SPHINX_${_uc}_EXECUTABLE "")
    endif()
...
function(sphinx_add_docs _target)
    ...
    if(_args_BREATHE_PROJECTS)
        ...
        list(APPEND SPHINX_EXTENSIONS sphinx_rtd_theme)
